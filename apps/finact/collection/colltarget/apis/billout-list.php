	...
	public function execute($options) {
		...
		try {
			...
			$stmt = $this->db->prepare("
				select 
				A.colltargetbillout_id, A.partner_id, A.billout_id, A.billout_isunreference, A.colltargetbillout_datetarget, A.colltargetbillout_notes, A.billout_idr, A.billout_isdiscvalue, A.billout_discp, A.billout_discval, A.billout_idrtopay, A.billout_ppntopay, A.billout_idrtotal, A.billout_datedue, A.billout_daystotarget, A.billout_totalitem, A.billout_totalqty, A.billout_salesgross, A.billout_discount, A.billout_subtotal, A.billout_pph, A.billout_nett, A.billout_ppn, A.billout_total, A.billout_totaladdcost, A.billout_dp, A.billout_payment, A.billout_paid, A.colltarget_id, A._createby, A._createdate, A._modifyby, A._modifydate 
