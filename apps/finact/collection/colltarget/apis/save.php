...
/**
 * finact/collection/colltarget/apis/save.php
 *
 * ====
 * Save
 * ====
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel header colltarget (trn_colltarget)
 *
...
$API = new class extends colltargetBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			unset($obj->colltarget_isapprovalprogress);
			unset($obj->colltarget_isapproved);
			unset($obj->colltarget_approveby);
			unset($obj->colltarget_approvedate);
			unset($obj->colltarget_isdeclined);
			unset($obj->colltarget_declineby);
			unset($obj->colltarget_declinedate);
