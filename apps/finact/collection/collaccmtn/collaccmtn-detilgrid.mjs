...
const btn_addrowmulti = $('#pnl_editdetilgrid-addrow');

const total_nett = $('#pnl_editdetilgrid-totalnett');
const total_ppn = $('#pnl_editdetilgrid-totalppn');
const total_pph = $('#pnl_editdetilgrid-totalpph')
const total_discval = $('#pnl_editdetilgrid-totaldiscval')
const total_idrtopay = $('#pnl_editdetilgrid-totalidrtopay')
const total_ppntopay = $('#pnl_editdetilgrid-totalppntopay')
const total_payment = $('#pnl_editdetilgrid-totalpayment')
...
export function createnew(data, options) {
	...
	grd_list.clear();
	txt_title.html(data.collaccmtn_descr)
	header_data = data;
}
...
export function OpenDetil(data) {
	...
	var fn_listloading = async (options) => {
		...
		options.criteria['id'] = data.collaccmtn_id
	}
