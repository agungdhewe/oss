...
/**
 * finact/collection/collaccmtn/apis/detil-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel detil collaccmtn (trn_collaccmtn)
 *
...
$API = new class extends collaccmtnBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			if ($obj->collaccmtndet_notes=='') { $obj->collaccmtndet_notes = '--NULL--'; }
			...
			try {
				...
				$header_table = 'trn_collaccmtn';
				$header_primarykey = 'collaccmtn_id';
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'collaccmtndet_id', 'billout_id', 'billout_datedue', 'billout_daystotarget', 'billout_idr', 'billout_ppn', 'billout_ppnval', 'billout_pph', 'billout_pphval', 'billout_idrnett', 'billout_discval', 'billout_idrtotal', 'billout_idrtopay', 'billout_ppntopay', 'collaccmtndet_notes', 'collaccmtn_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
