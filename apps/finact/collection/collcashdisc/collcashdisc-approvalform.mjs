...
const obj = {
	txt_collcashdiscappr_id: $('#pnl_editapprovalform-txt_collcashdiscappr_id'),
	chk_collcashdiscappr_isapproved: $('#pnl_editapprovalform-chk_collcashdiscappr_isapproved'),
	txt_collcashdiscappr_by: $('#pnl_editapprovalform-txt_collcashdiscappr_by'),
	txt_collcashdiscappr_date: $('#pnl_editapprovalform-txt_collcashdiscappr_date'),
	txt_collcashdisc_version: $('#pnl_editapprovalform-txt_collcashdisc_version'),
	chk_collcashdiscappr_isdeclined: $('#pnl_editapprovalform-chk_collcashdiscappr_isdeclined'),
	txt_collcashdiscappr_declinedby: $('#pnl_editapprovalform-txt_collcashdiscappr_declinedby'),
	txt_collcashdiscappr_declineddate: $('#pnl_editapprovalform-txt_collcashdiscappr_declineddate'),
	txt_collcashdiscappr_notes: $('#pnl_editapprovalform-txt_collcashdiscappr_notes'),
	txt_collcashdisc_id: $('#pnl_editapprovalform-txt_collcashdisc_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_collcashdiscappr_id,
		autoid: true,
		logview: 'trn_collcashdiscappr',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.collcashdisc_id)
	header_data = hdata
...
function form_idsetup(options) {
	var objid = obj.txt_collcashdiscappr_id
