	...
	persistent: {
		'trn_temprecv' : {
			...
			data: {
				...
				temprecv_commitby: { text: 'Commit By', type: dbtype.varchar(14), suppresslist: true, unset:true, options: { disabled: true }, hidden: true },
				...
				temprecv_isverify: { text: 'Verify', type: dbtype.boolean, null: false, default: '0', unset:true, options: { disabled: true } },
				temprecv_verifyby: { text: 'Verify By', type: dbtype.varchar(14), suppresslist: true, unset:true, options: { disabled: true }, hidden: true },
				temprecv_verifydate: { text: 'Verify Date', type: dbtype.datetime, suppresslist: true, unset:true, comp: comp.Textbox(), options: { disabled: true }, hidden: true },
