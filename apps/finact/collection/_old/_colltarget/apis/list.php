	...
	public function execute($options) {
		...
		try {
			...
			$stmt = $this->db->prepare("
				select 
				colltarget_id, colltarget_date, colltarget_iscommit, colltarget_commitby, colltarget_commitdate, partner_id, empl_id, _createby, _createdate, _modifyby, _modifydate 
