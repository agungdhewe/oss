...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->colltargetbillout_id = strtoupper($obj->colltargetbillout_id);
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey,  'colltargetbillout_id', 'colltargetbillout_notes', 'billout_id', 'billouttotal_validr', 'colltarget_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
