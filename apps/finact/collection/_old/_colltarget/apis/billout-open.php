...
class DataOpen extends WebAPI {
	...
	public function execute($options) {
		...
		try {
			...
			$sql = \FGTA4\utils\SqlUtility::Select('trn_colltargetbillout', [
				'colltargetbillout_id', 'colltargetbillout_notes', 'billout_id', 'billouttotal_validr', 'colltarget_id', '_createby', '_createdate', '_modifyby', '_modifydate' 
			], $where->sql);
