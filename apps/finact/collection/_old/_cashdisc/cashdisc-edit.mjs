...
const obj = {
	...
	txt_cashdiscount_version: $('#pnl_edit-txt_cashdiscount_version'),
	chk_cashdiscount_isapprovalprogress: $('#pnl_edit-chk_cashdiscount_isapprovalprogress'),
	chk_cashdiscount_isapproved: $('#pnl_edit-chk_cashdiscount_isapproved'),
	txt_cashdiscount_approveby: $('#pnl_edit-txt_cashdiscount_approveby'),
	txt_cashdiscount_approvedate: $('#pnl_edit-txt_cashdiscount_approvedate'),
	chk_cashdiscount_isdeclined: $('#pnl_edit-chk_cashdiscount_isdeclined'),
	txt_cashdiscount_declineby: $('#pnl_edit-txt_cashdiscount_declineby'),
	txt_cashdiscount_declinedate: $('#pnl_edit-txt_cashdiscount_declinedate')
}
...
function updaterecordstatus(record) {
	// apabila ada keperluan untuk update status record di sini
		...
		rec_commitby.html(record.cashdiscount_commitby);
		rec_commitdate.html(record.cashdiscount_commitdate);
		
		rec_approveby.html(record.cashdiscount_approveby);
		rec_approvedate.html(record.cashdiscount_approvedate);
		rec_declineby.html(record.cashdiscount_declineby);
		rec_declinedate.html(record.cashdiscount_declinedate);
...
function updatebuttonstate(record) {
	// apabila ada keperluan untuk update state action button di sini
		...
		if (record.cashdiscount_isfirm=="1") {
			button_commit_on = false;
			button_uncommit_on = false;
			button_approve_on = false;
			button_decline_on = false;
			form.lock(true);	
		} else if (record.cashdiscount_isdeclined=="1" || record.cashdiscount_isuseralreadydeclined=="1") {
			button_commit_on = false;
			button_uncommit_on = true;
			button_approve_on = true;
			button_decline_on = false;
			form.lock(true);	
		} else if (record.cashdiscount_isapproved=="1" || record.cashdiscount_isuseralreadyapproved=="1") {
			button_commit_on = false;
			button_uncommit_on = false;
			button_approve_on = false;
			button_decline_on = true;	
			form.lock(true);	
		} else if (record.cashdiscount_isapprovalprogress=="1") {
			button_commit_on = false;
			button_uncommit_on = false;
			button_approve_on = true;
			button_decline_on = true;
			form.lock(true);	
		} else if (record.cashdiscount_iscommit=="1") {
			button_commit_on = false;
			button_uncommit_on = true;
			button_approve_on = true;
			button_decline_on = true;
...
function updategridstate(record) {
	...
	var col_commit = 'cashdiscount_iscommit';
	updategriddata[col_commit] = record.cashdiscount_iscommit;	
	
	var col_approveprogress = 'cashdiscount_isapprovalprogress';
	var col_approve = 'cashdiscount_isapprove'
	var col_decline = "cashdiscount_isdeclined"
	updategriddata[col_approveprogress] = record.cashdiscount_isapprovalprogress;
	updategriddata[col_approve] = record.cashdiscount_isapproved;
	updategriddata[col_decline] = record.cashdiscount_isdeclined;				
...
function btn_print_click() {
	...
	var printurl = 'index.php/printout/' + window.global.modulefullname + '/cashdisc.xprint?id=' + id;
...
async function btn_action_click(args) {
	...
	var txt_version = obj.txt_cashdiscount_version;
	var chk_iscommit = obj.chk_cashdiscount_iscommit;
	
	var chk_isapprovalprogress = obj.chk_cashdiscount_isapprovalprogress;	
	var chk_isapprove = obj.chk_cashdiscount_isapproved;
	var chk_isdeclined = obj.chk_cashdiscount_isdeclined;
