	...
	persistent: {
		'trn_temprecv': {
			...
			data: {
				...
				temprecv_validr: { text: 'IDR', type: dbtype.decimal(14, 2), null: false, default: 0, options: { required: true } },
				temprecv_taxidr: { text: 'Tax', type: dbtype.decimal(14, 2), null: false, default: 0, options: { required: true } },

				temprecv_bgnum: { text: 'No Giro', type: dbtype.varchar(90), null: false },
