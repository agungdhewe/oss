	...
	public function execute($data, $options) {
		...
		try {
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey, 'temprecv_id', 'temprecv_ref', 'temprecv_date', 'temprecv_descr', 'temprecv_iscommit', 'temprecv_commitby', 'temprecv_commitdate', 'temprecv_validr', 'temprecv_taxidr', 'temprecv_bgnum', 'billout_id', 'partner_id', 'empl_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
