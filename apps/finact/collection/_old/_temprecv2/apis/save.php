...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		...
		try {
			...
			// $obj->jurnal_or = $this->NewJurnalId('OR');	
			// $obj->jurnal_tax = $this->NewJurnalId('TP');	
			// $obj->jurnal_st = $this->NewJurnalId('ST');	
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey, 'temprecv_id', 'temprecv_ref', 'temprecv_date', 'temprecv_descr', 'temprecv_bgnum', 'temprecv_validrtotal', 'temprecv_taxidrtotal', 'temprecv_iscommit', 'temprecv_commitby', 'temprecv_commitdate', 'partner_id', 'empl_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
	...
	public function NewJurnalId($seqname){
		$dt = new \DateTime();	
		$ye = $dt->format("y");
		$mo = $dt->format("m");
		$seq = new Sequencer($this->db, 'seq_generalmonthly', $seqname, ['ye', 'mo']);
