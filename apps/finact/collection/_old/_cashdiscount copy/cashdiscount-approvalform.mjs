...
const obj = {
	txt_cashdiscountappr_id: $('#pnl_editapprovalform-txt_cashdiscountappr_id'),
	...
	chk_cashdiscountappr_isapproved: $('#pnl_editapprovalform-chk_cashdiscountappr_isapproved'),
	txt_cashdiscountappr_by: $('#pnl_editapprovalform-txt_cashdiscountappr_by'),
	txt_cashdiscountappr_date: $('#pnl_editapprovalform-txt_cashdiscountappr_date'),
	txt_cashdiscount_version: $('#pnl_editapprovalform-txt_cashdiscount_version'),
	chk_cashdiscountappr_isdeclined: $('#pnl_editapprovalform-chk_cashdiscountappr_isdeclined'),
	txt_cashdiscountappr_declinedby: $('#pnl_editapprovalform-txt_cashdiscountappr_declinedby'),
	txt_cashdiscountappr_declineddate: $('#pnl_editapprovalform-txt_cashdiscountappr_declineddate'),
	txt_cashdiscountappr_notes: $('#pnl_editapprovalform-txt_cashdiscountappr_notes'),
	txt_cashdiscount_id: $('#pnl_editapprovalform-txt_cashdiscount_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_cashdiscountappr_id,
		autoid: true,
		logview: 'trn_cashdiscountappr',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.cashdiscount_descr)
	header_data = hdata
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		data.cashdiscount_id= hdata.cashdiscount_id
...
function form_idsetup(options) {
	var objid = obj.txt_cashdiscountappr_id
