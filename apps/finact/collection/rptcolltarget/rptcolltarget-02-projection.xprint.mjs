...
async function generateReport(param) {
	...
	var apiurl = `${global.modulefullname}/get_02-projection`
	var args = {
		options: {
			criteria: {
	...
	try {
		...
		<tr>
			...
			<td class="col_group2_head_header val">W1</td>
			<td class="col_group2_head_header val">W2</td>
			<td class="col_group2_head_header val">W3</td>
			<td class="col_group2_head_header val">W4</td>
			<td class="col_group2_head_header val">W5</td>
			<td class="col_group2_head_header val">W6</td>
			<td class="col_group2_head_header val">Total</td>
			<td class="col_group2_head_header val">Total AR</td>
		...
		for (var record of result.records) {
			...
			var percent = Math.round((billout_idrtopay/ori_billout_idr) * 100)
			...
			<tr>
				...
				<td class="col_content val">${format_number(record.idrtopay_w1)}</td>
				<td class="col_content val">${format_number(record.idrtopay_w2)}</td>
				<td class="col_content val">${format_number(record.idrtopay_w3)}</td>
				<td class="col_content val">${format_number(record.idrtopay_w4)}</td>
				<td class="col_content val">${format_number(record.idrtopay_w5)}</td>
				<td class="col_content val">${format_number(record.idrtopay_w6)}</td>
				<td class="col_content val">${format_number(record.billout_idrtopay)}</td>
				<td class="col_content val">${format_number(record.ori_billout_idr)}</td>
		...
		<tr>
			...
			<td class="col_group2_head_header">&nbsp;</td>
			<td class="col_group2_head_header">&nbsp;</td>
			<td class="col_group2_head_header val">${format_number(total.idrtopay_w1)}</td>
			<td class="col_group2_head_header val">${format_number(total.idrtopay_w2)}</td>
			<td class="col_group2_head_header val">${format_number(total.idrtopay_w3)}</td>
			<td class="col_group2_head_header val">${format_number(total.idrtopay_w4)}</td>
			<td class="col_group2_head_header val">${format_number(total.idrtopay_w5)}</td>
			<td class="col_group2_head_header val">${format_number(total.idrtopay_w6)}</td>
			<td class="col_group2_head_header val">${format_number(total.billout_idrtopay)}</td>
			<td class="col_group2_head_header val">${format_number(total.ori_billout_idr)}</td>
			<td class="col_group2_head_header val">%</td>
		</tr>
		`).appendTo(obj_reporttable_body);
