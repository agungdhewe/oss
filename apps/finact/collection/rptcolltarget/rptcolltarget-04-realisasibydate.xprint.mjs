...
async function generateReport(param) {
	...
	var apiurl = `${global.modulefullname}/get_04-realisasibydate`
	var args = {
		options: {
			criteria: {
	...
	try {
		...
		<tr>
			...
			<td class="col_group2_head_header">Date</td>
		...
		for (var record of result.records) {
			...
			<tr>
				...
				<td class="col_content">${record.colltargetbillout_datetarget}</td>
