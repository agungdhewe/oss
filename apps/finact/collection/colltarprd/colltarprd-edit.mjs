...
const obj = {
	txt_colltarprd_id: $('#pnl_edit-txt_colltarprd_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_colltarprd_id,
		autoid: true,
		logview: 'mst_colltarprd',
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		$ui.getPages().ITEMS['pnl_editpartnerexcgrid'].handler.createnew(data, options)
...
function form_idsetup(options) {
	var objid = obj.txt_colltarprd_id
