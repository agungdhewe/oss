...
class PrintForm extends WebModule {
	function __construct() {
		// $logfilepath = __LOCALDB_DIR . "/output/logfile-colltemprecv.txt";
	...
	public function LoadPage() {
		...
		try {
			...
			$this->colltemprecv_id = $row['colltemprecv_id'];
	...
	function getSqlHeader() {
		return "
			...
			from trn_colltemprecv A where colltemprecv_id = :colltemprecv_id
		";
	}	
