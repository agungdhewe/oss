...
/**
 * finact/collection/collschupd/apis/xapi.base.php
 *
 * collschupdBase
 * Kelas dasar untuk keperluan-keperluan api
 * kelas ini harus di-inherit untuk semua api pada modul collschupd
 *
 ...
 * tanggal 26/10/2021
 */
class collschupdBase extends WebAPI {
	...
	function __construct() {
		...
		// $logfilepath = __LOCALDB_DIR . "/output//*collschupd*/.txt";
		// debug::disable();
