...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		$tablename = 'mst_collectorpartner';
		$primarykey = 'collectorparner_id';
		...
		try {
			...
			$obj->collectorparner_id = strtoupper($obj->collectorparner_id);
			...
			try {
				...
				$header_table = 'mst_collector';
				$header_primarykey = 'collector_id';
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey,  'collectorparner_id', 'partner_id', 'collector_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
