...
const obj = {
	txt_collector_id: $('#pnl_edit-txt_collector_id'),
	cbo_empl_id: $('#pnl_edit-cbo_empl_id'),
	txt_collector_name: $('#pnl_edit-txt_collector_name'),
	chk_collector_isdisabled: $('#pnl_edit-chk_collector_isdisabled')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_collector_id,
		autoid: true,
		logview: 'mst_collector',
	...
	new fgta4slideselect(obj.cbo_empl_id, {
		...
		OnSelected: (value, display, record) => {
			form.setValue(obj.txt_collector_name, record.empl_name);
		}
	})				
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		$ui.getPages().ITEMS['pnl_editmst_collectorpartnergrid'].handler.createnew(data, options)
...
function form_idsetup(options) {
	var objid = obj.txt_collector_id
