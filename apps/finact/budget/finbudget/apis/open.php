...
/**
 * finact/budget/finbudget/apis/open.php
 *
 * ====
 * Open
 * ====
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel header finbudget (mst_finbudget)
 *
...
$API = new class extends finbudgetBase {
	...
	public function execute($options) {
		$tablename = 'mst_finbudget';
		$primarykey = 'finbudget_id';
		...
		try {
			...
			$where = \FGTA4\utils\SqlUtility::BuildCriteria(
				$options->criteria,
				[
					"finbudget_id" => " finbudget_id = :finbudget_id "
				]
			);

			$sql = \FGTA4\utils\SqlUtility::Select('mst_finbudget A', [
