...
const obj = {
	txt_finbudgetappr_id: $('#pnl_editapprovalform-txt_finbudgetappr_id'),
	chk_finbudgetappr_isapproved: $('#pnl_editapprovalform-chk_finbudgetappr_isapproved'),
	txt_finbudgetappr_by: $('#pnl_editapprovalform-txt_finbudgetappr_by'),
	txt_finbudgetappr_date: $('#pnl_editapprovalform-txt_finbudgetappr_date'),
	txt_finbudget_version: $('#pnl_editapprovalform-txt_finbudget_version'),
	chk_finbudgetappr_isdeclined: $('#pnl_editapprovalform-chk_finbudgetappr_isdeclined'),
	txt_finbudgetappr_declinedby: $('#pnl_editapprovalform-txt_finbudgetappr_declinedby'),
	txt_finbudgetappr_declineddate: $('#pnl_editapprovalform-txt_finbudgetappr_declineddate'),
	txt_finbudgetappr_notes: $('#pnl_editapprovalform-txt_finbudgetappr_notes'),
	txt_finbudget_id: $('#pnl_editapprovalform-txt_finbudget_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_finbudgetappr_id,
		autoid: true,
		logview: 'mst_finbudgetappr',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.finbudget_id)
	header_data = hdata
...
function form_idsetup(options) {
	var objid = obj.txt_finbudgetappr_id
