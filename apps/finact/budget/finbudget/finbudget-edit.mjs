...
const obj = {
	txt_finbudget_id: $('#pnl_edit-txt_finbudget_id'),
	txt_finbudget_year: $('#pnl_edit-txt_finbudget_year'),
	txt_finbudget_notes: $('#pnl_edit-txt_finbudget_notes'),
	cbo_dept_id: $('#pnl_edit-cbo_dept_id'),
	chk_finbudget_iscommit: $('#pnl_edit-chk_finbudget_iscommit'),
	txt_finbudget_commitby: $('#pnl_edit-txt_finbudget_commitby'),
	txt_finbudget_commitdate: $('#pnl_edit-txt_finbudget_commitdate'),
	chk_finbudget_isapprovalprogress: $('#pnl_edit-chk_finbudget_isapprovalprogress'),
	chk_finbudget_isapproved: $('#pnl_edit-chk_finbudget_isapproved'),
	txt_finbudget_approveby: $('#pnl_edit-txt_finbudget_approveby'),
	txt_finbudget_approvedate: $('#pnl_edit-txt_finbudget_approvedate'),
	chk_finbudget_isdeclined: $('#pnl_edit-chk_finbudget_isdeclined'),
	txt_finbudget_declineby: $('#pnl_edit-txt_finbudget_declineby'),
	txt_finbudget_declinedate: $('#pnl_edit-txt_finbudget_declinedate'),
	txt_finbudget_version: $('#pnl_edit-txt_finbudget_version'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_finbudget_id,
		autoid: true,
		logview: 'mst_finbudget',
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		data.finbudget_year = 0
		data.finbudget_iscommit = '0'
		data.finbudget_isapprovalprogress = '0'
		data.finbudget_isapproved = '0'
		data.finbudget_isdeclined = '0'
		data.finbudget_version = 0
...
function updaterecordstatus(record) {
	// apabila ada keperluan untuk update status record di sini
		...
		rec_commitby.html(record.finbudget_commitby);
		rec_commitdate.html(record.finbudget_commitdate);
		
		rec_approveby.html(record.finbudget_approveby);
		rec_approvedate.html(record.finbudget_approvedate);
		rec_declineby.html(record.finbudget_declineby);
		rec_declinedate.html(record.finbudget_declinedate);
...
function updatebuttonstate(record) {
	// apabila ada keperluan untuk update state action button di sini
		...
		if (record.finbudget_isfirm=="1") {
			button_commit_on = false;
			button_uncommit_on = false;
			button_approve_on = false;
			button_decline_on = false;
			form.lock(true);	
		} else if (record.finbudget_isdeclined=="1" || record.finbudget_isuseralreadydeclined=="1") {
			button_commit_on = false;
			button_uncommit_on = true;
			button_approve_on = true;
			button_decline_on = false;
			form.lock(true);	
		} else if (record.finbudget_isapproved=="1" || record.finbudget_isuseralreadyapproved=="1") {
			button_commit_on = false;
			button_uncommit_on = false;
			button_approve_on = false;
			button_decline_on = true;	
			form.lock(true);	
		} else if (record.finbudget_isapprovalprogress=="1") {
			button_commit_on = false;
			button_uncommit_on = false;
			button_approve_on = true;
			button_decline_on = true;
			form.lock(true);	
		} else if (record.finbudget_iscommit=="1") {
			button_commit_on = false;
			button_uncommit_on = true;
			button_approve_on = true;
			button_decline_on = true;
...
function updategridstate(record) {
	...
	var col_commit = 'finbudget_iscommit';
	updategriddata[col_commit] = record.finbudget_iscommit;	
	
	var col_approveprogress = 'finbudget_isapprovalprogress';
	var col_approve = 'finbudget_isapprove'
	var col_decline = "finbudget_isdeclined"
	updategriddata[col_approveprogress] = record.finbudget_isapprovalprogress;
	updategriddata[col_approve] = record.finbudget_isapproved;
	updategriddata[col_decline] = record.finbudget_isdeclined;				
...
function form_idsetup(options) {
	var objid = obj.txt_finbudget_id
...
function btn_print_click() {
	...
	var id = obj.txt_finbudget_id.textbox('getValue');
	var printurl = 'index.php/printout/' + window.global.modulefullname + '/finbudget.xprint?id=' + id;
...
async function btn_action_click(args) {
	...
	var docname = 'Finance Budget'
	var txt_version = obj.txt_finbudget_version;
	var chk_iscommit = obj.chk_finbudget_iscommit;
	
	var chk_isapprovalprogress = obj.chk_finbudget_isapprovalprogress;	
	var chk_isapprove = obj.chk_finbudget_isapproved;
	var chk_isdeclined = obj.chk_finbudget_isdeclined;
