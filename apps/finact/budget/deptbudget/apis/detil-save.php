...
/**
 * finact/budget/deptbudget/apis/detil-save.php
 *
 * ==========
 * Detil-Save
 * ==========
	...
	public function execute($data, $options) {
		...
		try {
			...
			try {
				...
				$header_table = 'mst_deptbudget';
				$header_primarykey = 'deptbudget_id';
				...
				// summary
				$deptbudget_id = $record['deptbudget_id'];
