...
/**
 * finact/budget/projbudget/apis/detil-save.php
 *
 * ==========
 * Detil-Save
 * ==========
		...
		try {
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'projbudgetdet_id', 'accbudget_id', 'alloc_dept_id', 'projbudgetdet_descr', 'projbudgetdet_qty', 'projbudgetdet_days', 'projbudgetdet_task', 'projbudgetdet_rate', 'projbudgetdet_value', 'projbudget_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
