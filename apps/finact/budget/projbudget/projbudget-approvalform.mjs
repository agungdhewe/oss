...
const obj = {
	txt_projbudgetappr_id: $('#pnl_editapprovalform-txt_projbudgetappr_id'),
	chk_projbudgetappr_isapproved: $('#pnl_editapprovalform-chk_projbudgetappr_isapproved'),
	txt_projbudgetappr_by: $('#pnl_editapprovalform-txt_projbudgetappr_by'),
	txt_projbudgetappr_date: $('#pnl_editapprovalform-txt_projbudgetappr_date'),
	txt_projbudget_version: $('#pnl_editapprovalform-txt_projbudget_version'),
	chk_projbudgetappr_isdeclined: $('#pnl_editapprovalform-chk_projbudgetappr_isdeclined'),
	txt_projbudgetappr_declinedby: $('#pnl_editapprovalform-txt_projbudgetappr_declinedby'),
	txt_projbudgetappr_declineddate: $('#pnl_editapprovalform-txt_projbudgetappr_declineddate'),
	txt_projbudgetappr_notes: $('#pnl_editapprovalform-txt_projbudgetappr_notes'),
	txt_projbudget_id: $('#pnl_editapprovalform-txt_projbudget_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_projbudgetappr_id,
		autoid: true,
		logview: 'mst_projbudgetappr',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.projbudget_id)
	header_data = hdata
...
function form_idsetup(options) {
	var objid = obj.txt_projbudgetappr_id
