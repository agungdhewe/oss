...
const obj = {
	txt_accbudgetformat_id: $('#pnl_edit-txt_accbudgetformat_id'),
	txt_accbudgetformat_name: $('#pnl_edit-txt_accbudgetformat_name'),
	txt_accbudgetformat_descr: $('#pnl_edit-txt_accbudgetformat_descr')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_accbudgetformat_id,
		autoid: false,
		logview: 'mst_accbudgetformat',
...
function form_idsetup(options) {
	var objid = obj.txt_accbudgetformat_id
