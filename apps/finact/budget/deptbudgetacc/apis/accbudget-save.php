...
/**
 * finact/budget/deptbudgetacc/apis/accbudget-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel accbudget deptbudgetacc (mst_dept)
 *
	...
	public function execute($data, $options) {
		...
		try {
			...
			try {
				...
				$header_table = 'mst_dept';
				$header_primarykey = 'dept_id';
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'deptbudgetacc_id', 'accbudget_id', 'accbudget_nameshort', 'dept_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
