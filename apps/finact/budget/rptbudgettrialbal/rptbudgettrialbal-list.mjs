...
function btn_load_click() {
	...
	// var reportmodule = window.global.modulefullname + '/rptbudgettrialbal.xprint' + '?template=format-01-a4-landscape';
	var reportmodule = window.global.modulefullname + '/rptbudgettrialbal.xprint';
	var params = {
		dt: dt
	}
