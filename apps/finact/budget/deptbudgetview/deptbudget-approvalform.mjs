...
const obj = {
	txt_deptbudgetappr_id: $('#pnl_editapprovalform-txt_deptbudgetappr_id'),
	chk_deptbudgetappr_isapproved: $('#pnl_editapprovalform-chk_deptbudgetappr_isapproved'),
	txt_deptbudgetappr_by: $('#pnl_editapprovalform-txt_deptbudgetappr_by'),
	txt_deptbudgetappr_date: $('#pnl_editapprovalform-txt_deptbudgetappr_date'),
	txt_deptbudget_version: $('#pnl_editapprovalform-txt_deptbudget_version'),
	chk_deptbudgetappr_isdeclined: $('#pnl_editapprovalform-chk_deptbudgetappr_isdeclined'),
	txt_deptbudgetappr_declinedby: $('#pnl_editapprovalform-txt_deptbudgetappr_declinedby'),
	txt_deptbudgetappr_declineddate: $('#pnl_editapprovalform-txt_deptbudgetappr_declineddate'),
	txt_deptbudgetappr_notes: $('#pnl_editapprovalform-txt_deptbudgetappr_notes'),
	txt_deptbudget_id: $('#pnl_editapprovalform-txt_deptbudget_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_deptbudgetappr_id,
		autoid: true,
		logview: 'mst_deptbudgetappr',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_deptbudgetappr_id
