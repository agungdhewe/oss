...
/**
 * finact/budget/corpbudget/apis/approval-open.php
 *
 * ==========
 * Detil-Open
 * ==========
	...
	public function execute($options) {
		...
		try {
			...
			$where = \FGTA4\utils\SqlUtility::BuildCriteria(
				$options->criteria,
				[
					"corpbudgetappr_id" => " corpbudgetappr_id = :corpbudgetappr_id "
				]
			);

			$sql = \FGTA4\utils\SqlUtility::Select('mst_corpbudgetappr A', [
