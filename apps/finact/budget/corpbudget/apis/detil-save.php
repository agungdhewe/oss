...
/**
 * finact/budget/corpbudget/apis/detil-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel detil corpbudget (mst_corpbudget)
 *
...
$API = new class extends corpbudgetBase {
	...
	public function execute($data, $options) {
		$tablename = 'mst_corpbudgetdet';
		$primarykey = 'corpbudgetdet_id';
		...
		try {
			...
			try {
				...
				$header_table = 'mst_corpbudget';
				$header_primarykey = 'corpbudget_id';
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey
				, 'corpbudgetdet_id', 'corpbudgetdet_descr', 'corpbudgetdet_01', 'corpbudgetdet_02', 'corpbudgetdet_03', 'corpbudgetdet_04', 'corpbudgetdet_05', 'corpbudgetdet_06', 'corpbudgetdet_07', 'corpbudgetdet_08', 'corpbudgetdet_09', 'corpbudgetdet_10', 'corpbudgetdet_11', 'corpbudgetdet_12', 'corpbudgetdet_total', 'accbudget_id', 'corpbudgetdet_notes', 'corpbudget_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
