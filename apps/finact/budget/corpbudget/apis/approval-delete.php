...
/**
 * finact/budget/corpbudget/apis/approval-delete.php
 *
 * ============
 * Detil-Delete
 * ============
 * Menghapus satu baris data/record berdasarkan PrimaryKey
 * pada tabel approval corpbudget (mst_corpbudget)
 *
...
$API = new class extends corpbudgetBase {
	...
	public function execute($data, $options) {
		$tablename = 'mst_corpbudgetappr';
		$primarykey = 'corpbudgetappr_id';
