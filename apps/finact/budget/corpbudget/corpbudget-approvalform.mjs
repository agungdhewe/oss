...
const obj = {
	txt_corpbudgetappr_id: $('#pnl_editapprovalform-txt_corpbudgetappr_id'),
	chk_corpbudgetappr_isapproved: $('#pnl_editapprovalform-chk_corpbudgetappr_isapproved'),
	txt_corpbudgetappr_by: $('#pnl_editapprovalform-txt_corpbudgetappr_by'),
	txt_corpbudgetappr_date: $('#pnl_editapprovalform-txt_corpbudgetappr_date'),
	txt_corpbudget_version: $('#pnl_editapprovalform-txt_corpbudget_version'),
	chk_corpbudgetappr_isdeclined: $('#pnl_editapprovalform-chk_corpbudgetappr_isdeclined'),
	txt_corpbudgetappr_declinedby: $('#pnl_editapprovalform-txt_corpbudgetappr_declinedby'),
	txt_corpbudgetappr_declineddate: $('#pnl_editapprovalform-txt_corpbudgetappr_declineddate'),
	txt_corpbudgetappr_notes: $('#pnl_editapprovalform-txt_corpbudgetappr_notes'),
	txt_corpbudget_id: $('#pnl_editapprovalform-txt_corpbudget_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_corpbudgetappr_id,
		autoid: true,
		logview: 'mst_corpbudgetappr',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_corpbudgetappr_id
