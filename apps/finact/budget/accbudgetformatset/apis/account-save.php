...
/**
 * finact/budget/accbudgetformatset/apis/account-save.php
 *
 * ==========
 * Detil-Save
 * ==========
		...
		try {
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'accbudgetformatsetitem_id', 'accbudget_id', 'accbudget_nameshort', 'accbudgetformat_id', 'accbudgetformatset_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
