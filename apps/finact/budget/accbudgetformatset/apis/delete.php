...
/**
 * finact/budget/accbudgetformatset/apis/delete.php
 *
 * ======
 * Delete
 * ======
 * Menghapus satu baris data/record berdasarkan PrimaryKey
 * pada tabel header accbudgetformatset (mst_accbudgetformatset)
 *
	...
	public function execute($data, $options) {
		...
		try {
			...
			try {
				...
				$tabletodelete = ['mst_accbudgetformatsetitem', 'mst_accbudgetformatsetitem'];
