...
/**
 * finact/budget/accbudgetformatset/apis/save.php
 *
 * ====
 * Save
 * ====
...
$API = new class extends accbudgetformatsetBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->accbudgetformatset_path = strtoupper($obj->accbudgetformatset_path);
			$obj->accbudgetformatset_pathid = strtoupper($obj->accbudgetformatset_pathid);
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					...
					, 'accbudgetformatset_parent', 'accbudgetformatset_path', 'accbudgetformatset_pathid', 'accbudgetformatset_level', 'accbudgetformat_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
