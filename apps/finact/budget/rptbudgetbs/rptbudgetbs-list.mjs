...
function btn_load_click() {
	...
	var reportmodule = window.global.modulefullname + '/rptbudgetbs.xprint' + '?template=format-01-a3-landscape';
	// var reportmodule = window.global.modulefullname + '/rptbudgetbs.xprint' + '?template=format-01-a4-landscape';
	// var reportmodule = window.global.modulefullname + '/rptbudgetbs.xprint';
	var params = {
		dt: dt
	}
