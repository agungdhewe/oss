...
/**
 * finact/budget/projbudgetrev/apis/save.php
 *
 * ====
 * Save
 * ====
...
$API = new class extends projbudgetrevBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->projbudgetrev_id = strtoupper($obj->projbudgetrev_id);
			...
			unset($obj->projbudgetrev_version);
			unset($obj->projbudgetrev_iscommit);
			unset($obj->projbudgetrev_commitby);
			unset($obj->projbudgetrev_commitdate);
			unset($obj->projbudgetrev_isapprovalprogress);
			unset($obj->projbudgetrev_isapproved);
			unset($obj->projbudgetrev_approveby);
			unset($obj->projbudgetrev_approvedate);
			unset($obj->projbudgetrev_isdeclined);
			unset($obj->projbudgetrev_declineby);
			unset($obj->projbudgetrev_declinedate);
			unset($obj->projbudgetrev_isclose);
			unset($obj->projbudgetrev_closeby);
			unset($obj->projbudgetrev_closedate);
