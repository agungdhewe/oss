...
const obj = {
	txt_projbudgetrevappr_id: $('#pnl_editapprovalform-txt_projbudgetrevappr_id'),
	chk_projbudgetrevappr_isapproved: $('#pnl_editapprovalform-chk_projbudgetrevappr_isapproved'),
	txt_projbudgetrevappr_by: $('#pnl_editapprovalform-txt_projbudgetrevappr_by'),
	txt_projbudgetrevappr_date: $('#pnl_editapprovalform-txt_projbudgetrevappr_date'),
	txt_projbudgetrev_version: $('#pnl_editapprovalform-txt_projbudgetrev_version'),
	chk_projbudgetrevappr_isdeclined: $('#pnl_editapprovalform-chk_projbudgetrevappr_isdeclined'),
	txt_projbudgetrevappr_declinedby: $('#pnl_editapprovalform-txt_projbudgetrevappr_declinedby'),
	txt_projbudgetrevappr_declineddate: $('#pnl_editapprovalform-txt_projbudgetrevappr_declineddate'),
	txt_projbudgetrevappr_notes: $('#pnl_editapprovalform-txt_projbudgetrevappr_notes'),
	txt_projbudgetrev_id: $('#pnl_editapprovalform-txt_projbudgetrev_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_projbudgetrevappr_id,
		autoid: true,
		logview: 'mst_projbudgetrevappr',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_projbudgetrevappr_id
