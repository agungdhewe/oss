...
const obj = {
	...
	txt_projbudgetrev_descr: $('#pnl_edit-txt_projbudgetrev_descr'),
	...
	chk_projbudgetrev_iscommit: $('#pnl_edit-chk_projbudgetrev_iscommit'),
	txt_projbudgetrev_commitby: $('#pnl_edit-txt_projbudgetrev_commitby'),
	txt_projbudgetrev_commitdate: $('#pnl_edit-txt_projbudgetrev_commitdate'),
	chk_projbudgetrev_isapprovalprogress: $('#pnl_edit-chk_projbudgetrev_isapprovalprogress'),
	chk_projbudgetrev_isapproved: $('#pnl_edit-chk_projbudgetrev_isapproved'),
	txt_projbudgetrev_approveby: $('#pnl_edit-txt_projbudgetrev_approveby'),
	txt_projbudgetrev_approvedate: $('#pnl_edit-txt_projbudgetrev_approvedate'),
	chk_projbudgetrev_isdeclined: $('#pnl_edit-chk_projbudgetrev_isdeclined'),
	txt_projbudgetrev_declineby: $('#pnl_edit-txt_projbudgetrev_declineby'),
	txt_projbudgetrev_declinedate: $('#pnl_edit-txt_projbudgetrev_declinedate'),
	chk_projbudgetrev_isclose: $('#pnl_edit-chk_projbudgetrev_isclose'),
	txt_projbudgetrev_closeby: $('#pnl_edit-txt_projbudgetrev_closeby'),
	txt_projbudgetrev_closedate: $('#pnl_edit-txt_projbudgetrev_closedate')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_projbudgetrev_id,
		autoid: true,
		logview: 'mst_projbudgetrev',
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		data.projbudgetrev_isapproved = '0'
...
function updaterecordstatus(record) {
	// apabila ada keperluan untuk update status record di sini
		...
		rec_commitby.html(record.projbudgetrev_commitby);
		rec_commitdate.html(record.projbudgetrev_commitdate);
		
		rec_approveby.html(record.projbudgetrev_approveby);
		rec_approvedate.html(record.projbudgetrev_approvedate);
		rec_declineby.html(record.projbudgetrev_declineby);
		rec_declinedate.html(record.projbudgetrev_declinedate);
...
function updatebuttonstate(record) {
	// apabila ada keperluan untuk update state action button di sini
		...
		if (record.projbudgetrev_isfirm=="1") {
			button_commit_on = false;
			button_uncommit_on = false;
			button_approve_on = false;
			button_decline_on = false;
			form.lock(true);	
		} else if (record.projbudgetrev_isdeclined=="1" || record.projbudgetrev_isuseralreadydeclined=="1") {
			button_commit_on = false;
			button_uncommit_on = true;
			button_approve_on = true;
			button_decline_on = false;
			form.lock(true);	
		} else if (record.projbudgetrev_isapproved=="1" || record.projbudgetrev_isuseralreadyapproved=="1") {
			button_commit_on = false;
			button_uncommit_on = false;
			button_approve_on = false;
			button_decline_on = true;	
			form.lock(true);	
		} else if (record.projbudgetrev_isapprovalprogress=="1") {
			button_commit_on = false;
			button_uncommit_on = false;
			button_approve_on = true;
			button_decline_on = true;
			form.lock(true);	
		} else if (record.projbudgetrev_iscommit=="1") {
			button_commit_on = false;
			button_uncommit_on = true;
			button_approve_on = true;
			button_decline_on = true;
...
function updategridstate(record) {
	...
	var col_commit = 'projbudgetrev_iscommit';
	updategriddata[col_commit] = record.projbudgetrev_iscommit;	
	
	var col_approveprogress = 'projbudgetrev_isapprovalprogress';
	var col_approve = 'projbudgetrev_isapprove'
	var col_decline = "projbudgetrev_isdeclined"
	updategriddata[col_approveprogress] = record.projbudgetrev_isapprovalprogress;
	updategriddata[col_approve] = record.projbudgetrev_isapproved;
	updategriddata[col_decline] = record.projbudgetrev_isdeclined;				
...
function form_idsetup(options) {
	var objid = obj.txt_projbudgetrev_id
...
function btn_print_click() {
	...
	var id = obj.txt_projbudgetrev_id.textbox('getValue');
	var printurl = 'index.php/printout/' + window.global.modulefullname + '/projbudgetrev.xprint?id=' + id;
...
async function btn_action_click(args) {
	...
	var docname = 'Budget Project Revisi'
	var txt_version = obj.txt_projbudgetrev_version;
	var chk_iscommit = obj.chk_projbudgetrev_iscommit;
	
	var chk_isapprovalprogress = obj.chk_projbudgetrev_isapprovalprogress;	
	var chk_isapprove = obj.chk_projbudgetrev_isapproved;
	var chk_isdeclined = obj.chk_projbudgetrev_isdeclined;
