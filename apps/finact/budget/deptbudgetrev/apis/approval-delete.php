...
/**
 * finact/budget/deptbudgetrev/apis/approval-delete.php
 *
 * ============
 * Detil-Delete
 * ============
 * Menghapus satu baris data/record berdasarkan PrimaryKey
 * pada tabel approval deptbudgetrev (mst_deptbudgetrev)
 *
...
$API = new class extends deptbudgetrevBase {
	...
	public function execute($data, $options) {
		$tablename = 'mst_deptbudgetrevappr';
		$primarykey = 'deptbudgetrevappr_id';
