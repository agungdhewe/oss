	...
	public function execute($options) {
		...
		try {
			...
			$stmt = $this->db->prepare("
					select count(*) as n 
					from mst_deptbudgetrev A inner join TEMP_TOAPPROVE B on B.deptbudgetrev_id = A.deptbudgetrev_id
				" 
				. $where->sql
			);
			...
			$stmt = $this->db->prepare("
					select 
					  A.deptbudgetrev_id, A.deptbudgetrev_year, A.deptbudgetrev_month, A.deptbudgetrev_descr
					, A.deptbudgetrev_notes, A.deptbudgetrev_version, A.dept_id, A.doc_id, A.deptbudgetrev_iscommit
					, A.deptbudgetrev_commitby, A.deptbudgetrev_commitdate, A.deptbudgetrev_isapprovalprogress
					, A.deptbudgetrev_isapproved, A.deptbudgetrev_approveby, A.deptbudgetrev_approvedate
					, A.deptbudgetrev_isdeclined, A.deptbudgetrev_declineby, A.deptbudgetrev_declinedate
					, A.deptbudgetrev_isveryfied, A.deptbudgetrev_verifyby, A.deptbudgetrev_verifydate
					, A._createby, A._createdate, A._modifyby, A._modifydate 
					from mst_deptbudgetrev A inner join TEMP_TOAPPROVE B on B.deptbudgetrev_id = A.deptbudgetrev_id
				" 
				. $where->sql 
				. " order by A.deptbudgetrev_year desc, A.deptbudgetrev_month desc"
				. $limit
			);
			$stmt->execute($where->params);
