...
export function OpenDetil(data) {
	...
	var fn_listloading = async (options) => {
		...
		options.criteria.deptbudget_year = data.deptbudgetrev_year
		options.criteria.deptbudget_month = data.deptbudgetrev_month
		options.criteria.dept_id = data.dept_id
	}
