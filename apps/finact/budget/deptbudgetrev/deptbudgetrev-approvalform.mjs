...
const obj = {
	txt_deptbudgetrevappr_id: $('#pnl_editapprovalform-txt_deptbudgetrevappr_id'),
	chk_deptbudgetrevappr_isapproved: $('#pnl_editapprovalform-chk_deptbudgetrevappr_isapproved'),
	txt_deptbudgetrevappr_by: $('#pnl_editapprovalform-txt_deptbudgetrevappr_by'),
	txt_deptbudgetrevappr_date: $('#pnl_editapprovalform-txt_deptbudgetrevappr_date'),
	txt_deptbudgetrev_version: $('#pnl_editapprovalform-txt_deptbudgetrev_version'),
	chk_deptbudgetrevappr_isdeclined: $('#pnl_editapprovalform-chk_deptbudgetrevappr_isdeclined'),
	txt_deptbudgetrevappr_declinedby: $('#pnl_editapprovalform-txt_deptbudgetrevappr_declinedby'),
	txt_deptbudgetrevappr_declineddate: $('#pnl_editapprovalform-txt_deptbudgetrevappr_declineddate'),
	txt_deptbudgetrevappr_notes: $('#pnl_editapprovalform-txt_deptbudgetrevappr_notes'),
	txt_deptbudgetrev_id: $('#pnl_editapprovalform-txt_deptbudgetrev_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_deptbudgetrevappr_id,
		autoid: true,
		logview: 'mst_deptbudgetrevappr',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_deptbudgetrevappr_id
