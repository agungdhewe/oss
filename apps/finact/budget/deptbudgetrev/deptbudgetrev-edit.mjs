...
const obj = {
	txt_deptbudgetrev_id: $('#pnl_edit-txt_deptbudgetrev_id'),
	txt_deptbudgetrev_year: $('#pnl_edit-txt_deptbudgetrev_year'),
	txt_deptbudgetrev_month: $('#pnl_edit-txt_deptbudgetrev_month'),
	txt_deptbudgetrev_descr: $('#pnl_edit-txt_deptbudgetrev_descr'),
	txt_deptbudgetrev_notes: $('#pnl_edit-txt_deptbudgetrev_notes'),
	txt_deptbudgetrev_version: $('#pnl_edit-txt_deptbudgetrev_version'),
	cbo_dept_id: $('#pnl_edit-cbo_dept_id'),
	cbo_doc_id: $('#pnl_edit-cbo_doc_id'),
	chk_deptbudgetrev_iscommit: $('#pnl_edit-chk_deptbudgetrev_iscommit'),
	txt_deptbudgetrev_commitby: $('#pnl_edit-txt_deptbudgetrev_commitby'),
	txt_deptbudgetrev_commitdate: $('#pnl_edit-txt_deptbudgetrev_commitdate'),
	chk_deptbudgetrev_isapprovalprogress: $('#pnl_edit-chk_deptbudgetrev_isapprovalprogress'),
	chk_deptbudgetrev_isapproved: $('#pnl_edit-chk_deptbudgetrev_isapproved'),
	txt_deptbudgetrev_approveby: $('#pnl_edit-txt_deptbudgetrev_approveby'),
	txt_deptbudgetrev_approvedate: $('#pnl_edit-txt_deptbudgetrev_approvedate'),
	chk_deptbudgetrev_isdeclined: $('#pnl_edit-chk_deptbudgetrev_isdeclined'),
	txt_deptbudgetrev_declineby: $('#pnl_edit-txt_deptbudgetrev_declineby'),
	txt_deptbudgetrev_declinedate: $('#pnl_edit-txt_deptbudgetrev_declinedate'),
	chk_deptbudgetrev_isveryfied: $('#pnl_edit-chk_deptbudgetrev_isveryfied'),
	txt_deptbudgetrev_verifyby: $('#pnl_edit-txt_deptbudgetrev_verifyby'),
	txt_deptbudgetrev_verifydate: $('#pnl_edit-txt_deptbudgetrev_verifydate')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_deptbudgetrev_id,
		autoid: true,
		logview: 'mst_deptbudgetrev',
...
export function open(data, rowid, viewmode=true, fn_callback) {
	...
	var fn_dataopened = async (result, options) => {
		...
		form.setDisable(obj.txt_deptbudgetrev_year, true);
		form.setDisable(obj.txt_deptbudgetrev_month, true);
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		data.deptbudgetrev_year = global.setup.current_year
		data.deptbudgetrev_month = global.setup.current_month
		data.deptbudgetrev_version = 0
		data.deptbudgetrev_iscommit = '0'
		data.deptbudgetrev_isapprovalprogress = '0'
		data.deptbudgetrev_isapproved = '0'
		data.deptbudgetrev_isdeclined = '0'
		data.deptbudgetrev_isveryfied = '0'
		...
		form.setDisable(obj.txt_deptbudgetrev_year, false);
		form.setDisable(obj.txt_deptbudgetrev_month, false);
...
function updaterecordstatus(record) {
	// apabila ada keperluan untuk update status record di sini
		...
		rec_commitby.html(record.deptbudgetrev_commitby);
		rec_commitdate.html(record.deptbudgetrev_commitdate);
		
		rec_approveby.html(record.deptbudgetrev_approveby);
		rec_approvedate.html(record.deptbudgetrev_approvedate);
		rec_declineby.html(record.deptbudgetrev_declineby);
		rec_declinedate.html(record.deptbudgetrev_declinedate);
...
function updatebuttonstate(record) {
	// apabila ada keperluan untuk update state action button di sini
		...
		if (record.deptbudgetrev_isfirm=="1") {
			button_commit_on = false;
			button_uncommit_on = false;
			button_approve_on = false;
			button_decline_on = false;
			form.lock(true);	
		} else if (record.deptbudgetrev_isdeclined=="1" || record.deptbudgetrev_isuseralreadydeclined=="1") {
			button_commit_on = false;
			button_uncommit_on = true;
			button_approve_on = true;
			button_decline_on = false;
			form.lock(true);	
		} else if (record.deptbudgetrev_isapproved=="1" || record.deptbudgetrev_isuseralreadyapproved=="1") {
			button_commit_on = false;
			button_uncommit_on = false;
			button_approve_on = false;
			button_decline_on = true;	
			form.lock(true);	
		} else if (record.deptbudgetrev_isapprovalprogress=="1") {
			button_commit_on = false;
			button_uncommit_on = false;
			button_approve_on = true;
			button_decline_on = true;
			form.lock(true);	
		} else if (record.deptbudgetrev_iscommit=="1") {
			button_commit_on = false;
			button_uncommit_on = true;
			button_approve_on = true;
			button_decline_on = true;
		...
		// patch from standard
		if (record.deptbudgetrev_isapproved=="1") {
			// setelah approve sudah tidak bisa decline lagi, soalnya sudah di generate ke budget
			button_decline_on = false;
		}
...
function updategridstate(record) {
	...
	var col_commit = 'deptbudgetrev_iscommit';
	updategriddata[col_commit] = record.deptbudgetrev_iscommit;	
	
	var col_approveprogress = 'deptbudgetrev_isapprovalprogress';
	var col_approve = 'deptbudgetrev_isapprove'
	var col_decline = "deptbudgetrev_isdeclined"
	updategriddata[col_approveprogress] = record.deptbudgetrev_isapprovalprogress;
	updategriddata[col_approve] = record.deptbudgetrev_isapproved;
	updategriddata[col_decline] = record.deptbudgetrev_isdeclined;				
...
function form_idsetup(options) {
	var objid = obj.txt_deptbudgetrev_id
...
function btn_print_click() {
	...
	var id = obj.txt_deptbudgetrev_id.textbox('getValue');
	var printurl = 'index.php/printout/' + window.global.modulefullname + '/deptbudgetrev.xprint?id=' + id;
...
async function btn_action_click(args) {
	...
	var docname = 'Budget Department Revisi'
	var txt_version = obj.txt_deptbudgetrev_version;
	var chk_iscommit = obj.chk_deptbudgetrev_iscommit;
	
	var chk_isapprovalprogress = obj.chk_deptbudgetrev_isapprovalprogress;	
	var chk_isapprove = obj.chk_deptbudgetrev_isapproved;
	var chk_isdeclined = obj.chk_deptbudgetrev_isdeclined;
