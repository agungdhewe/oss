...
ALTER TABLE `mst_inquirymodel` ADD COLUMN IF NOT EXISTS  `inquirymodel_isqtybreakdown` tinyint(1) NOT NULL DEFAULT 0 AFTER `trxmodel_id`;
...
ALTER TABLE `mst_inquirymodel` MODIFY COLUMN IF EXISTS  `inquirymodel_isqtybreakdown` tinyint(1) NOT NULL DEFAULT 0 AFTER `trxmodel_id`;
