	...
	public function execute($options) {
		...
		try {
			...
			$stmt = $this->db->prepare("
				select 
				A.inquirymodel_id, A.inquirymodel_name, A.inquirymodel_descr, A.inquirymodel_isqtybreakdown, A.inquirymodel_isdateinterval, A._createby, A._createdate, A._modifyby, A._modifydate 
