	...
	persistent: {
		'mst_inquirytype': {
			...
			data: {
				...
				inquirytype_name: { text: 'Inquiry Type', type: dbtype.varchar(90), null: false, options: { required: true, invalidMessage: 'Nama Tipe harus diisi' } },
				...
				inquirytype_isallowadvance: { text: 'Allow using Advance Request', type: dbtype.boolean, null: false, default: '0',suppresslist: true,  options: { labelWidth: '300px' } },
				inquirytype_isemplaspartner: { text: 'Responsible Empl reg as partner', type: dbtype.boolean, null: false, default: '0',suppresslist: true,  options: { labelWidth: '300px' } },
				inquirytype_maxadvancevalue: { text: 'Max Advance Value', type: dbtype.decimal(12,0), null: false, default: '0', suppresslist: true },
				...
				// inquirytype_isshowitemasset: { text: 'Show Itemasset', type: dbtype.boolean, null: false, default: '0', suppresslist:true, options:{ labelWidth:'300px', disabled: true} },
				// inquirytype_isshowitem: { text: 'Show Item', type: dbtype.boolean, null: false, default: '0', suppresslist:true, options:{ labelWidth:'300px', disabled: true} },
				// inquirytype_isshowitemstock: { text: 'Show Itemstock', type: dbtype.boolean, null: false, default: '0', suppresslist:true, options:{ labelWidth:'300px', disabled: true} },
				// inquirytype_isshowpartner: { text: 'Show Partner', type: dbtype.boolean, null: false, default: '0', suppresslist:true,  options:{ labelWidth:'300px', disabled: true} },
				// inquirytype_isshowitemclass: { text: 'Show Itemclass', type: dbtype.boolean, null: false, default: '0', suppresslist:true, options:{ labelWidth:'300px', disabled: true} },
				// inquirytype_isitemclassdisabled: { text: 'Itemclass Disabled', type: dbtype.boolean, null: false, default: '0', suppresslist:true, options:{ labelWidth:'300px', disabled: true} },
			...
			data: {
				...
				itemclass_id: {
					...
					comp: comp.Combo({
						...
						field_value: 'itemclass_id', field_display: 'itemclass_name', field_display_name: 'itemclass_name', 
						field_mappings: [
							`{mapping: 'owner_dept_name', text: 'owner_dept_name'}`
						],
						api: 'finact/items/itemclass/list',
