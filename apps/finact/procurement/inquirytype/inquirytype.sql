...
ALTER TABLE `mst_inquirytype` ADD COLUMN IF NOT EXISTS  `inquirytype_isallowadvance` tinyint(1) NOT NULL DEFAULT 0 AFTER `itemmanage_id`;
...
ALTER TABLE `mst_inquirytype` ADD COLUMN IF NOT EXISTS  `related_dept_id` varchar(30)   AFTER `inquirytype_maxadvancevalue`;
...
ALTER TABLE `mst_inquirytype` ADD COLUMN IF NOT EXISTS  `site_id` varchar(30)   AFTER `owner_team_id`;
ALTER TABLE `mst_inquirytype` ADD COLUMN IF NOT EXISTS  `room_id` varchar(30)   AFTER `site_id`;
ALTER TABLE `mst_inquirytype` ADD COLUMN IF NOT EXISTS  `orderout_dept_id` varchar(30) NOT NULL  AFTER `room_id`;
...
ALTER TABLE `mst_inquirytype` ADD COLUMN IF NOT EXISTS  `inquirytype_isuseqty` tinyint(1) NOT NULL DEFAULT 0 AFTER `orderout_doc_id`;
...
ALTER TABLE `mst_inquirytype` ADD COLUMN IF NOT EXISTS  `inquirytype_isallowoverbudget` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquirytype_islimitvalue`;
ALTER TABLE `mst_inquirytype` ADD COLUMN IF NOT EXISTS  `inquirytype_isallowunbudget` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquirytype_isallowoverbudget`;
ALTER TABLE `mst_inquirytype` ADD COLUMN IF NOT EXISTS  `inquirytype_isdeptuser` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquirytype_isallowunbudget`;
...
ALTER TABLE `mst_inquirytype` MODIFY COLUMN IF EXISTS  `inquirytype_isallowadvance` tinyint(1) NOT NULL DEFAULT 0 AFTER `itemmanage_id`;
...
ALTER TABLE `mst_inquirytype` MODIFY COLUMN IF EXISTS  `related_dept_id` varchar(30)   AFTER `inquirytype_maxadvancevalue`;
ALTER TABLE `mst_inquirytype` MODIFY COLUMN IF EXISTS  `related_team_id` varchar(14)   AFTER `related_dept_id`;
ALTER TABLE `mst_inquirytype` MODIFY COLUMN IF EXISTS  `owner_dept_id` varchar(30)   AFTER `related_team_id`;
ALTER TABLE `mst_inquirytype` MODIFY COLUMN IF EXISTS  `owner_team_id` varchar(14)   AFTER `owner_dept_id`;
ALTER TABLE `mst_inquirytype` MODIFY COLUMN IF EXISTS  `site_id` varchar(30)   AFTER `owner_team_id`;
ALTER TABLE `mst_inquirytype` MODIFY COLUMN IF EXISTS  `room_id` varchar(30)   AFTER `site_id`;
ALTER TABLE `mst_inquirytype` MODIFY COLUMN IF EXISTS  `orderout_dept_id` varchar(30) NOT NULL  AFTER `room_id`;
...
ALTER TABLE `mst_inquirytype` MODIFY COLUMN IF EXISTS  `inquirytype_isuseqty` tinyint(1) NOT NULL DEFAULT 0 AFTER `orderout_doc_id`;
...
ALTER TABLE `mst_inquirytype` MODIFY COLUMN IF EXISTS  `inquirytype_isallowoverbudget` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquirytype_islimitvalue`;
ALTER TABLE `mst_inquirytype` MODIFY COLUMN IF EXISTS  `inquirytype_isallowunbudget` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquirytype_isallowoverbudget`;
ALTER TABLE `mst_inquirytype` MODIFY COLUMN IF EXISTS  `inquirytype_isdeptuser` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquirytype_isallowunbudget`;
