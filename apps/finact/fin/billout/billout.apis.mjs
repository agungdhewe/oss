...
export const load_orderinterm_id = 'finact/sales/orderin/terms-list'
...
export const load_owner_dept_id = 'ent/organisation/dept/list-selector'
export const load_trxmodel_id = 'finact/master/trxmodel/list'
export const load_doc_id = 'ent/organisation/docs/list'
export const load_billoutrowtype_id = 'finact/fin/billoutrowtype/list'
export const load_orderindelv_id = 'finact/sales/orderindelv/list'
