...
ALTER TABLE `trn_billout` ADD COLUMN IF NOT EXISTS  `sales_dept_id` varchar(30) NOT NULL  AFTER `billtype_id`;
ALTER TABLE `trn_billout` ADD COLUMN IF NOT EXISTS  `orderin_id` varchar(30)   AFTER `sales_dept_id`;
...
ALTER TABLE `trn_billout` ADD COLUMN IF NOT EXISTS  `trxmodel_id` varchar(10) NOT NULL  AFTER `billout_payment`;
ALTER TABLE `trn_billout` ADD COLUMN IF NOT EXISTS  `dept_id` varchar(30)   AFTER `trxmodel_id`;
ALTER TABLE `trn_billout` ADD COLUMN IF NOT EXISTS  `doc_id` varchar(30) NOT NULL  AFTER `dept_id`;
...
ALTER TABLE `trn_billout` MODIFY COLUMN IF EXISTS  `sales_dept_id` varchar(30) NOT NULL  AFTER `billtype_id`;
ALTER TABLE `trn_billout` MODIFY COLUMN IF EXISTS  `orderin_id` varchar(30)   AFTER `sales_dept_id`;
...
ALTER TABLE `trn_billout` MODIFY COLUMN IF EXISTS  `trxmodel_id` varchar(10) NOT NULL  AFTER `billout_payment`;
ALTER TABLE `trn_billout` MODIFY COLUMN IF EXISTS  `dept_id` varchar(30)   AFTER `trxmodel_id`;
ALTER TABLE `trn_billout` MODIFY COLUMN IF EXISTS  `doc_id` varchar(30) NOT NULL  AFTER `dept_id`;
...
ALTER TABLE `trn_billout` ADD CONSTRAINT `fk_trn_billout_mst_dept` FOREIGN KEY IF NOT EXISTS  (`sales_dept_id`) REFERENCES `mst_dept` (`dept_id`);
...
ALTER TABLE `trn_billout` ADD CONSTRAINT `fk_trn_billout_mst_dept_2` FOREIGN KEY IF NOT EXISTS  (`dept_id`) REFERENCES `mst_dept` (`dept_id`);
