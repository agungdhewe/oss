...
const obj = {
	txt_itemstocksaldo_id: $('#pnl_edit-txt_itemstocksaldo_id'),
	txt_itemstocksaldo_ref: $('#pnl_edit-txt_itemstocksaldo_ref'),
	txt_itemstocksaldo_date: $('#pnl_edit-txt_itemstocksaldo_date'),
	cbo_itemstock_id: $('#pnl_edit-cbo_itemstock_id'),
	cbo_site_id: $('#pnl_edit-cbo_site_id'),
	txt_itemstocksaldo_qty: $('#pnl_edit-txt_itemstocksaldo_qty'),
	txt_itemstocksaldo_value: $('#pnl_edit-txt_itemstocksaldo_value')
}
