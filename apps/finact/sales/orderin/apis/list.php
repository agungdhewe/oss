	...
	public function execute($options) {
		...
		try {
			...
			$stmt = $this->db->prepare("
				select 
				A.orderin_id, A.unit_id, A.orderintype_id, A.orderin_ref, A.orderin_descr, A.orderin_dtstart, A.orderin_dtend, A.partner_id, A.ae_empl_id, A.trxmodel_id, A.project_id, A.ppn_taxtype_id, A.ppn_taxvalue, A.ppn_include, A.pph_taxtype_id, A.pph_taxvalue, A.sales_coa_id, A.salesdisc_coa_id, A.ppn_coa_id, A.ppnsubsidi_coa_id, A.pph_coa_id, A.sales_dept_id, A.orderin_totalitem, A.orderin_totalqty, A.orderin_salesgross, A.orderin_discount, A.orderin_subtotal, A.orderin_pph, A.orderin_nett, A.orderin_ppn, A.orderin_total, A.orderin_totaladdcost, A.orderin_payment, A.orderin_version, A.orderin_isdateinterval, A.orderin_iscommit, A.orderin_commitby, A.orderin_commitdate, A.orderin_isclose, A.orderin_closeby, A.orderin_closedate, A.orderin_isautogenerated, A._createby, A._createdate, A._modifyby, A._modifydate 
				from trn_orderin A
			" . $where->sql . $limit);
			$stmt->execute($where->params);
