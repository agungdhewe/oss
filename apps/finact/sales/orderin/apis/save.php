		...
		try {
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'orderin_id', 'unit_id', 'orderintype_id', 'orderin_ref', 'orderin_descr', 'orderin_dtstart', 'orderin_dtend', 'partner_id', 'ae_empl_id', 'trxmodel_id', 'project_id', 'ppn_taxtype_id', 'ppn_taxvalue', 'ppn_include', 'pph_taxtype_id', 'pph_taxvalue', 'sales_coa_id', 'salesdisc_coa_id', 'ppn_coa_id', 'ppnsubsidi_coa_id', 'pph_coa_id', 'sales_dept_id', 'orderin_totalitem', 'orderin_totalqty', 'orderin_salesgross', 'orderin_discount', 'orderin_subtotal', 'orderin_pph', 'orderin_nett', 'orderin_ppn', 'orderin_total', 'orderin_totaladdcost', 'orderin_payment', 'orderin_version', 'orderin_isdateinterval', 'orderin_iscommit', 'orderin_commitby', 'orderin_commitdate', 'orderin_isclose', 'orderin_closeby', 'orderin_closedate', 'orderin_isautogenerated', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
