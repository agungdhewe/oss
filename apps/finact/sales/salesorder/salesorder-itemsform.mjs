...
const obj = {
	txt_salesorderitem_id: $('#pnl_edititemsform-txt_salesorderitem_id'),
	cbo_itemclass_id: $('#pnl_edititemsform-cbo_itemclass_id'),
	txt_salesorderitem_descr: $('#pnl_edititemsform-txt_salesorderitem_descr'),
	cbo_curr_id: $('#pnl_edititemsform-cbo_curr_id'),
	txt_salesorderitem_validr: $('#pnl_edititemsform-txt_salesorderitem_validr'),
	txt_salesorderitem_discountidr: $('#pnl_edititemsform-txt_salesorderitem_discountidr'),
	txt_salesorderitem_totalidr: $('#pnl_edititemsform-txt_salesorderitem_totalidr'),
	txt_salesorder_id: $('#pnl_edititemsform-txt_salesorder_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_salesorderitem_id,
		autoid: true,
		logview: 'trn_salesorderitem',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.salesorder_descr)
	header_data = hdata
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		...
		data.salesorderitem_validr = 0
		data.salesorderitem_discountidr = 0
		data.salesorderitem_totalidr = 0
...
function form_idsetup(options) {
	var objid = obj.txt_salesorderitem_id
