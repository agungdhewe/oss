...
const obj = {
	txt_salesorderappr_id: $('#pnl_editapprovalform-txt_salesorderappr_id'),
	chk_salesorderappr_isapproved: $('#pnl_editapprovalform-chk_salesorderappr_isapproved'),
	txt_salesorderappr_by: $('#pnl_editapprovalform-txt_salesorderappr_by'),
	txt_salesorderappr_date: $('#pnl_editapprovalform-txt_salesorderappr_date'),
	txt_salesorder_version: $('#pnl_editapprovalform-txt_salesorder_version'),
	chk_salesorderappr_isdeclined: $('#pnl_editapprovalform-chk_salesorderappr_isdeclined'),
	txt_salesorderappr_declinedby: $('#pnl_editapprovalform-txt_salesorderappr_declinedby'),
	txt_salesorderappr_declineddate: $('#pnl_editapprovalform-txt_salesorderappr_declineddate'),
	txt_salesorderappr_notes: $('#pnl_editapprovalform-txt_salesorderappr_notes'),
	txt_salesorder_id: $('#pnl_editapprovalform-txt_salesorder_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_salesorderappr_id,
		autoid: true,
		logview: 'trn_salesorderappr',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.salesorder_id)
	header_data = hdata
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		data.salesorder_id= hdata.salesorder_id
...
function form_idsetup(options) {
	var objid = obj.txt_salesorderappr_id
