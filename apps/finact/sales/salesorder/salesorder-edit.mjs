...
const obj = {
	txt_salesorder_id: $('#pnl_edit-txt_salesorder_id'),
	dt_salesorder_date: $('#pnl_edit-dt_salesorder_date'),
	txt_salesorder_descr: $('#pnl_edit-txt_salesorder_descr'),
	txt_salesorder_ref: $('#pnl_edit-txt_salesorder_ref'),
	cbo_ae_empl_id: $('#pnl_edit-cbo_ae_empl_id'),
	cbo_partner_id: $('#pnl_edit-cbo_partner_id'),
	chk_salesorder_istax: $('#pnl_edit-chk_salesorder_istax'),
	...
	txt_salesorder_version: $('#pnl_edit-txt_salesorder_version'),
	chk_salesorder_iscommit: $('#pnl_edit-chk_salesorder_iscommit'),
	txt_salesorder_commitby: $('#pnl_edit-txt_salesorder_commitby'),
	txt_salesorder_commitdate: $('#pnl_edit-txt_salesorder_commitdate'),
	chk_salesorder_isapprovalprogress: $('#pnl_edit-chk_salesorder_isapprovalprogress'),
	chk_salesorder_isapproved: $('#pnl_edit-chk_salesorder_isapproved'),
	txt_salesorder_approveby: $('#pnl_edit-txt_salesorder_approveby'),
	txt_salesorder_approvedate: $('#pnl_edit-txt_salesorder_approvedate'),
	chk_salesorder_isdeclined: $('#pnl_edit-chk_salesorder_isdeclined'),
	txt_salesorder_declineby: $('#pnl_edit-txt_salesorder_declineby'),
	txt_salesorder_declinedate: $('#pnl_edit-txt_salesorder_declinedate'),
	txt_salesorder_notes: $('#pnl_edit-txt_salesorder_notes'),
	chk_salesorder_isclose: $('#pnl_edit-chk_salesorder_isclose'),
	txt_salesorder_closeby: $('#pnl_edit-txt_salesorder_closeby'),
	txt_salesorder_closedate: $('#pnl_edit-txt_salesorder_closedate')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_salesorder_id,
		autoid: true,
		logview: 'trn_salesorder',
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		data.salesorder_date = global.now()
		data.salesorder_istax = '1'
		data.salesorder_version = 0
		data.salesorder_iscommit = '0'
		data.salesorder_isapprovalprogress = '0'
		data.salesorder_isapproved = '0'
		data.salesorder_isdeclined = '0'
		data.salesorder_isclose = '0'
		...
		data.salesordertype_id = 'SA'
		data.salesordertype_name = 'SALES'
...
function updaterecordstatus(record) {
	// apabila ada keperluan untuk update status record di sini
		...
		rec_commitby.html(record.salesorder_commitby);
		rec_commitdate.html(record.salesorder_commitdate);
		
		rec_approveby.html(record.salesorder_approveby);
		rec_approvedate.html(record.salesorder_approvedate);
		rec_declineby.html(record.salesorder_declineby);
		rec_declinedate.html(record.salesorder_declinedate);
...
function updatebuttonstate(record) {
	// apabila ada keperluan untuk update state action button di sini
		...
		if (record.salesorder_isfirm=="1") {
			button_commit_on = false;
			button_uncommit_on = false;
			button_approve_on = false;
			button_decline_on = false;
			form.lock(true);	
		} else if (record.salesorder_isdeclined=="1" || record.salesorder_isuseralreadydeclined=="1") {
			button_commit_on = false;
			button_uncommit_on = true;
			button_approve_on = true;
			button_decline_on = false;
			form.lock(true);	
		} else if (record.salesorder_isapproved=="1" || record.salesorder_isuseralreadyapproved=="1") {
			button_commit_on = false;
			button_uncommit_on = false;
			button_approve_on = false;
			button_decline_on = true;	
			form.lock(true);	
		} else if (record.salesorder_isapprovalprogress=="1") {
			button_commit_on = false;
			button_uncommit_on = false;
			button_approve_on = true;
			button_decline_on = true;
			form.lock(true);	
		} else if (record.salesorder_iscommit=="1") {
			button_commit_on = false;
			button_uncommit_on = true;
			button_approve_on = true;
			button_decline_on = true;
...
function updategridstate(record) {
	...
	var col_commit = 'salesorder_iscommit';
	updategriddata[col_commit] = record.salesorder_iscommit;	
	
	var col_approveprogress = 'salesorder_isapprovalprogress';
	var col_approve = 'salesorder_isapprove'
	var col_decline = "salesorder_isdeclined"
	updategriddata[col_approveprogress] = record.salesorder_isapprovalprogress;
	updategriddata[col_approve] = record.salesorder_isapproved;
	updategriddata[col_decline] = record.salesorder_isdeclined;				
...
function form_idsetup(options) {
	var objid = obj.txt_salesorder_id
...
function btn_print_click() {
	...
	var id = obj.txt_salesorder_id.textbox('getValue');
	var printurl = 'index.php/printout/' + window.global.modulefullname + '/salesorder.xprint?id=' + id;
...
async function btn_action_click(args) {
	...
	var txt_version = obj.txt_salesorder_version;
	var chk_iscommit = obj.chk_salesorder_iscommit;
	
	var chk_isapprovalprogress = obj.chk_salesorder_isapprovalprogress;	
	var chk_isapprove = obj.chk_salesorder_isapproved;
	var chk_isdeclined = obj.chk_salesorder_isdeclined;
