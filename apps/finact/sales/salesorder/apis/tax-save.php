...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		$tablename = 'trn_salesordertax';
		$primarykey = 'salesordertax_id';
		...
		try {
			...
			$obj->salesordertax_id = strtoupper($obj->salesordertax_id);
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey,  'salesordertax_id', 'salesordertax_valfrg', 'salesordertax_valfrgrate', 'salesordertax_validr', 'coa_id', 'taxtype_id', 'curr_id', 'salesorder_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
