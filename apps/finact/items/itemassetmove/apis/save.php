		...
		try {
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'itemassetmove_id', 'inquiry_id', 'itemassetmove_dtstart', 'itemassetmove_dtend', 'itemassetmove_descr', 'from_site_id', 'to_site_id', 'user_dept_id', 'empl_id', 'project_id', 'projecttask_id', 'projbudget_id', 'projbudgettask_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
