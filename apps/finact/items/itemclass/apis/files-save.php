...
$API = new class extends itemclassBase {
	...
	public function execute($data, $options, $files) {
		...
		if (class_exists('itemclass_headerHandler')) {
		...
		try {
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'itemclassfiles_id', 'doctype_id', 'itemclassfiles_descr', 'itemclassfiles_order', 'itemclassfiles_file', 'itemclass_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
