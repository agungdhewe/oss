...
ALTER TABLE `mst_itemclass` ADD COLUMN IF NOT EXISTS  `itemclass_name` varchar(30) NOT NULL  AFTER `itemclass_id`;
...
ALTER TABLE `mst_itemclass` ADD COLUMN IF NOT EXISTS  `itemmodel_id` varchar(10) NOT NULL  AFTER `itemclass_descr`;
ALTER TABLE `mst_itemclass` ADD COLUMN IF NOT EXISTS  `itemclassgroup_id` varchar(17)   AFTER `itemmodel_id`;
ALTER TABLE `mst_itemclass` ADD COLUMN IF NOT EXISTS  `owner_dept_id` varchar(30) NOT NULL  AFTER `itemclassgroup_id`;
ALTER TABLE `mst_itemclass` ADD COLUMN IF NOT EXISTS  `maintainer_dept_id` varchar(30) NOT NULL  AFTER `owner_dept_id`;
ALTER TABLE `mst_itemclass` ADD COLUMN IF NOT EXISTS  `unitmeasurement_id` varchar(10) NOT NULL  AFTER `maintainer_dept_id`;
ALTER TABLE `mst_itemclass` ADD COLUMN IF NOT EXISTS  `itemmanage_id` varchar(2) NOT NULL  AFTER `unitmeasurement_id`;
ALTER TABLE `mst_itemclass` ADD COLUMN IF NOT EXISTS  `itemclass_minassetvalue` decimal(11, 2) NOT NULL DEFAULT 0 AFTER `itemmanage_id`;
ALTER TABLE `mst_itemclass` ADD COLUMN IF NOT EXISTS  `inquiry_accbudget_id` varchar(20) NOT NULL  AFTER `itemclass_minassetvalue`;
ALTER TABLE `mst_itemclass` ADD COLUMN IF NOT EXISTS  `settl_coa_id` varchar(17) NOT NULL  AFTER `inquiry_accbudget_id`;
ALTER TABLE `mst_itemclass` ADD COLUMN IF NOT EXISTS  `cost_coa_id` varchar(17)   AFTER `settl_coa_id`;
ALTER TABLE `mst_itemclass` ADD COLUMN IF NOT EXISTS  `depremodel_id` varchar(10)   AFTER `cost_coa_id`;
...
ALTER TABLE `mst_itemclass` MODIFY COLUMN IF EXISTS  `itemclass_name` varchar(30) NOT NULL  AFTER `itemclass_id`;
...
ALTER TABLE `mst_itemclass` MODIFY COLUMN IF EXISTS  `itemclassgroup_id` varchar(17)   AFTER `itemmodel_id`;
ALTER TABLE `mst_itemclass` MODIFY COLUMN IF EXISTS  `owner_dept_id` varchar(30) NOT NULL  AFTER `itemclassgroup_id`;
ALTER TABLE `mst_itemclass` MODIFY COLUMN IF EXISTS  `maintainer_dept_id` varchar(30) NOT NULL  AFTER `owner_dept_id`;
...
ALTER TABLE `mst_itemclass` MODIFY COLUMN IF EXISTS  `inquiry_accbudget_id` varchar(20) NOT NULL  AFTER `itemclass_minassetvalue`;
ALTER TABLE `mst_itemclass` MODIFY COLUMN IF EXISTS  `settl_coa_id` varchar(17) NOT NULL  AFTER `inquiry_accbudget_id`;
ALTER TABLE `mst_itemclass` MODIFY COLUMN IF EXISTS  `cost_coa_id` varchar(17)   AFTER `settl_coa_id`;
ALTER TABLE `mst_itemclass` MODIFY COLUMN IF EXISTS  `depremodel_id` varchar(10)   AFTER `cost_coa_id`;
...
ALTER TABLE `mst_itemclass` ADD KEY IF NOT EXISTS `cost_coa_id` (`cost_coa_id`);
...
ALTER TABLE `mst_itemclass` ADD CONSTRAINT `fk_mst_itemclass_mst_coa_2` FOREIGN KEY IF NOT EXISTS  (`cost_coa_id`) REFERENCES `mst_coa` (`coa_id`);
...
ALTER TABLE `mst_itemclassaccbudget` ADD COLUMN IF NOT EXISTS  `settl_coa_id` varchar(17) NOT NULL  AFTER `inquiry_accbudget_id`;
ALTER TABLE `mst_itemclassaccbudget` ADD COLUMN IF NOT EXISTS  `itemclass_id` varchar(14) NOT NULL  AFTER `settl_coa_id`;
...
ALTER TABLE `mst_itemclassaccbudget` MODIFY COLUMN IF EXISTS  `settl_coa_id` varchar(17) NOT NULL  AFTER `inquiry_accbudget_id`;
ALTER TABLE `mst_itemclassaccbudget` MODIFY COLUMN IF EXISTS  `itemclass_id` varchar(14) NOT NULL  AFTER `settl_coa_id`;
...
ALTER TABLE `mst_itemclassaccbudget` ADD KEY IF NOT EXISTS `settl_coa_id` (`settl_coa_id`);
...
ALTER TABLE `mst_itemclassaccbudget` ADD CONSTRAINT `fk_mst_itemclassaccbudget_mst_coa` FOREIGN KEY IF NOT EXISTS  (`settl_coa_id`) REFERENCES `mst_coa` (`coa_id`);
