...
const obj = {
	...
	txt_itemstock_barcode: $('#pnl_edit-txt_itemstock_barcode'),
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		data.itemstock_lastqtyupdate = 0
		...
		$ui.getPages().ITEMS['pnl_editsettinggrid'].handler.createnew(data, options)
