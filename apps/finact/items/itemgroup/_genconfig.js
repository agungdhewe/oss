...
module.exports = {
	...
	persistent: {
		'mst_itemgroup' : {
			...
			data: {
				itemgroup_id: {text:'ID', type: dbtype.varchar(17), null:false, uppercase: true, options:{required:true,invalidMessage:'ID Group harus diisi'}},
				itemgroup_name: {text:'Item Group Name', type: dbtype.varchar(60), null:false, uppercase: true, options:{required:true,invalidMessage:'Nama Group harus diisi'}},
				itemgroup_nameshort: {text:'Item Group Name', type: dbtype.varchar(60), null:false, uppercase: true, options:{required:true,invalidMessage:'Nama Group harus diisi'}},
				itemgroup_descr: {text:'Descr', type: dbtype.varchar(90), null:true, uppercase: false, suppresslist: true},
				...
				itemgroup_pathid: {text:'PathId', type: dbtype.varchar(17), null:false, uppercase: false, suppresslist: true, options:{disabled:true}},
				itemgroup_path: {text:'Path', type: dbtype.varchar(390), null:true, uppercase: false, suppresslist: true, options:{disabled:true}},
				itemgroup_level: {text:'Level', type: dbtype.int(2), null:false, default:'0', uppercase: false, suppresslist: true, options:{disabled:true}},
				itemgroup_isexselect : {text:'Exclude From Selection', type: dbtype.boolean, null:false, default:'0'},

				itemmodel_id: { 
					text: 'Model', type: dbtype.varchar(10), uppercase: true, null: true, 
