...
/**
 * finact/acct/payable/apis/detil-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel detil payable (trn_jurnal)
 *
...
$API = new class extends payableBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			// if ($obj->billindetil_id=='--NULL--') { unset($obj->billindetil_id); }
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'jurnaldetil_id', 'billin_id', 'billindetil_id', 'partner_id', 'jurnaldetil_descr', 'jurnaldetil_valfrg', 'curr_id', 'jurnaldetil_valfrgrate', 'jurnaldetil_validr', 'coa_id', 'dept_id', 'jurnal_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
				...
				'billindetil_descr' => \FGTA4\utils\SqlUtility::Lookup($record['billindetil_id'], $this->db, 'trn_billin', 'billindetil_id', 'billindetil_descr'),
