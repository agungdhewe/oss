...
/**
 * finact/acct/payable/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header payable (trn_jurnal)
...
$API = new class extends payableBase {
	...
	public function execute($options) {
		...
		try {
			...
			$stmt = $this->db->prepare("select count(*) as n from view_jurnalap A" . $where->sql);
