...
/**
 * finact/acct/payable/apis/xapi.base.php
 *
 * payableBase
 * Kelas dasar untuk keperluan-keperluan api
 * kelas ini harus di-inherit untuk semua api pada modul payable
 *
 ...
 * tanggal 05/06/2021
 */
class payableBase extends WebAPI {
	...
	function __construct() {
		...
		// $logfilepath = __LOCALDB_DIR . "/output//*payable*/.txt";
		// debug::disable();
