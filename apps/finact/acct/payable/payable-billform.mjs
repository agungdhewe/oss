...
const obj = {
	...
	cbo_billin_id: $('#pnl_editbillform-cbo_billin_id'),
	cbo_billindetil_id: $('#pnl_editbillform-cbo_billindetil_id'),
...
export async function init(opt) {
	...
	obj.cbo_billin_id.name = 'pnl_editbillform-cbo_billin_id'		
	...
	obj.cbo_billindetil_id.name = 'pnl_editbillform-cbo_billindetil_id'		
