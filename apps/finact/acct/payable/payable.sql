...
ALTER TABLE `trn_jurnaldetil` ADD KEY `billindetil_id` (`billindetil_id`);
...
ALTER TABLE `trn_jurnaldetil` ADD CONSTRAINT `fk_trn_jurnaldetil_trn_billin_2` FOREIGN KEY (`billindetil_id`) REFERENCES `trn_billin` (`billindetil_id`);
