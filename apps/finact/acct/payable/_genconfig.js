...
module.exports = {
		...
		'trn_jurnaldetil' : {
			...
			data: {
				...
				billindetil_id: {
					...
					comp: comp.Combo({
						table: 'trn_billin',
						field_value: 'billindetil_id', field_display: 'billindetil_descr',
						api: 'finact/fin/billin/detil-list'
					})
				},
	...
	schema: {
		...
		detils: {
			...
			'bill': {title: 'Tagihan', table: 'trn_jurnaldetil', form: true, headerview: 'jurnal_descr' },
