...
const obj = {
	txt_coaformatsetitem_id: $('#pnl_editaccountform-txt_coaformatsetitem_id'),
	cbo_coa_id: $('#pnl_editaccountform-cbo_coa_id'),
	txt_coa_nameshort: $('#pnl_editaccountform-txt_coa_nameshort'),
	cbo_coaformat_id: $('#pnl_editaccountform-cbo_coaformat_id'),
	txt_coaformatset_id: $('#pnl_editaccountform-txt_coaformatset_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_coaformatsetitem_id,
		autoid: true,
		logview: 'mst_coaformatsetitem',
		btn_edit: btn_edit,
		btn_save: btn_save,
	...
	obj.cbo_coa_id.name = 'pnl_editaccountform-cbo_coa_id'		
	...
	obj.cbo_coaformat_id.name = 'pnl_editaccountform-cbo_coaformat_id'		
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.coaformatset_name)
	header_data = hdata
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		data.coaformatset_id= hdata.coaformatset_id
...
function form_idsetup(options) {
	var objid = obj.txt_coaformatsetitem_id
