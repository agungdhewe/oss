...
/**
 * finact/acct/coaformatset/apis/account-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel account coaformatset (mst_coaformatset)
 *
	...
	public function execute($data, $options) {
		...
		try {
			...
			try {
				...
				$header_table = 'mst_coaformatset';
				$header_primarykey = 'coaformatset_id';
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'coaformatsetitem_id', 'coa_id', 'coa_nameshort', 'coaformat_id', 'coaformatset_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
