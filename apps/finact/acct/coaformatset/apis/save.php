...
/**
 * finact/acct/coaformatset/apis/save.php
 *
 * ====
 * Save
 * ====
...
$API = new class extends coaformatsetBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->coaformatset_path = strtoupper($obj->coaformatset_path);
			$obj->coaformatset_pathid = strtoupper($obj->coaformatset_pathid);
