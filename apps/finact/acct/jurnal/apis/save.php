...
$API = new class extends jurnalBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			unset($obj->jurnal_ispayable);
			unset($obj->jurnal_isreceivable);
