	...
	public function execute($options) {
		...
		try {
			...
			$sql = \FGTA4\utils\SqlUtility::Select('trn_jurnal A', [
				'jurnal_id', 'jurnal_ref', 'jurnal_date', 'jurnal_datedue', 'jurnal_descr', 'periodemo_id', 'coa_id', 'dept_id', 'partner_id', 'jurnal_valfrg', 'curr_id', 'jurnal_valfrgrate', 'jurnal_validr', 'jurnaltype_id', 'jurnalsource_id', 'jurnal_version', 'jurnal_iscommit', 'jurnal_commitby', 'jurnal_commitdate', 'jurnal_ispost', 'jurnal_postby', 'jurnal_postdate', 'jurnal_isclose', 'jurnal_isagingclose', 'jurnal_ispayable', 'jurnal_isreceivable', '_createby', '_createdate', '_modifyby', '_modifydate'				
			], $where->sql);
			...
			$result->record = array_merge($record, [
				...
				//'jurnal_total' => abs($record['jurnal_total']),
				//'curr_islocal' => \FGTA4\utils\SqlUtility::Lookup($record['curr_id'], $this->db, 'mst_curr', 'curr_id', 'curr_islocal'),
