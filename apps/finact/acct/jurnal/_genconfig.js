	...
	persistent: {
		'trn_jurnal': {
			...
			data: {
				...
				jurnal_datedue: { text: 'Due Date', type: dbtype.date, null: false, suppresslist: true , hidden: true, options: {disabled: true} },
				...
				coa_id: {
					text:'Account', type: dbtype.varchar(20), null:true, suppresslist: true, hidden: true, 
				...
				curr_id: {
					...
					options:{required:true,invalidMessage:'Currency harus diisi', prompt:'-- PILIH --', disabled: false},
					comp: comp.Combo({
						table: 'mst_curr', 
						field_value: 'curr_id', field_display: 'curr_name', 
						api: 'ent/general/curr/list-with-currentrate',
						OnSelectedScript: `form.setValue(obj.txt_jurnal_valfrgrate, record.curr_rate)`
					})
				},
				...
				jurnaltype_id: {
					text:'Type', type: dbtype.varchar(10), null:false, suppresslist: true,  hidden: true,
				...
				jurnalsource_id: {
					text:'Source', type: dbtype.varchar(10), null:false, suppresslist: true,  hidden: true,
				...
				jurnal_ispayable: { text: 'Payable', type: dbtype.boolean, null: false, default: '0', suppresslist: true,  unset:true, hidden: true,  options: { disabled: true } },
				jurnal_isreceivable: { text: 'Receivable', type: dbtype.boolean, null: false, default: '0', suppresslist: true,  unset:true, hidden: true, options: { disabled: true } },
			...
			data: {
				...
				curr_id: {
					...
					comp: comp.Combo({
						...
						field_value: 'curr_id', field_display: 'curr_name', 						
						api: 'ent/general/curr/list-with-currentrate',
						OnSelectedScript: `form.setValue(obj.txt_jurnaldetil_valfrgrate, record.curr_rate)`
					})
				},
