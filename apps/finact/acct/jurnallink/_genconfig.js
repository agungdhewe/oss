	...
	persistent: {
		...
		'trn_jurnaldetil' : {
			...
			data: {
				...
				jurnaldetil_descr: { text: 'Descr', type: dbtype.varchar(255), null: false, uppercase: false, options: { required: true, invalidMessage: 'Descr harus diisi', disabled:true } },
				coa_id: {
					text:'Account', type: dbtype.varchar(20), null:false,
					options:{required:true, invalidMessage:'Account Biaya harus diisi', prompt:'-- PILIH --', disabled:true},
					comp: comp.Combo({
						table: 'mst_coa', 
				...
				partner_id: {
					options:{required:true,invalidMessage:'Partner harus diisi', prompt:'-- PILIH --', disabled:true},
				...
				jurnaldetil_valfrg: { text: 'Valas', type: dbtype.decimal(14, 2), null: false, default: 0, suppresslist: true, options: { required: true , disabled:true} },
				jurnaldetil_valfrgrate: { text: 'Rate', type: dbtype.decimal(14, 0), null: false, default: 0, suppresslist: true, options: { required: true , disabled:true} },
				...
				jurnaldetil_id_ref: {
					text:'Jurnal Reference', type: dbtype.varchar(14), null:false,
					options:{required:true,invalidMessage:'Reference harus diisi', prompt:'-- PILIH --'},
					comp: comp.Combo({
						table: 'trn_jurnaldetil', 
						field_value: 'jurnaldetil_id', field_display: 'jurnaldetil_descr',  
						api: 'finact/acct/jurnal/list-forreference'})
				},
...
CREATE INDEX trn_jurnal_jurnal_date_IDX USING BTREE ON fgtadb.trn_jurnal (jurnal_date);				  
