...
/**
 * finact/acct/jurnallink/apis/xapi.base.php
 *
 * jurnallinkBase
 * Kelas dasar untuk keperluan-keperluan api
 * kelas ini harus di-inherit untuk semua api pada modul jurnallink
 *
 ...
 * tanggal 17/05/2021
 */
class jurnallinkBase extends WebAPI {
	...
	function __construct() {
		...
		// $logfilepath = __LOCALDB_DIR . "/output//*jurnallink*/.txt";
		// debug::disable();
