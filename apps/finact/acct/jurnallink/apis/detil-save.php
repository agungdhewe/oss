...
/**
 * finact/acct/jurnallink/apis/detil-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel detil jurnallink (trn_jurnal)
 *
 ...
 * tanggal 17/05/2021
 */
$API = new class extends jurnallinkBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey
				, 'jurnaldetil_id', 'jurnaldetil_descr', 'coa_id', 'dept_id', 'partner_id', 'curr_id', 'jurnaldetil_valfrg', 'jurnaldetil_valfrgrate', 'jurnaldetil_validr', 'jurnaldetil_id_ref', 'jurnal_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
