...
$API = new class extends jurnalsaldoBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->periodesummary_id = strtoupper($obj->periodesummary_id);
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey
				, 'periodesummary_id', 'coamodel_id', 'coa_id', 'dept_id', 'partner_id', 'jurnalsaldo_awal', 'jurnalsaldo_mutasi', 'jurnalsaldo_akhir', 'periodemo_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
