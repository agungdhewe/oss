 ...
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel summary jurnalsaldo (mst_periodemo)
...
$API = new class extends jurnalsaldoBase {
	...
	public function execute($options) {
		...
		try {
			...
			$stmt = $this->db->prepare("select count(*) as n from trn_periodesummary A" . $where->sql);
