...
function btn_load_click() {
	...
	var reportmodule = window.global.modulefullname + '/rpttrialbal.xprint';
	switch (rpttype) {
		case 'bydept' :
			reportmodule = window.global.modulefullname + '/rpttrialbal.xprint-bydept?template=format-01-a4-landscape';
			break;
		case 'bypartner' :
			reportmodule = window.global.modulefullname + '/rpttrialbal.xprint-bypartner?template=format-01-a4-landscape';
			break;
		case 'bydeptpartner' :
			reportmodule = window.global.modulefullname + '/rpttrialbal.xprint-bydeptpartner?template=format-01-a4-landscape';
			break;
	}
