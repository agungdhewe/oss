...
/**
 * finact/acct/receivable/apis/xapi.base.php
 *
 * receivableBase
 * Kelas dasar untuk keperluan-keperluan api
 * kelas ini harus di-inherit untuk semua api pada modul receivable
 *
 ...
 * tanggal 08/06/2021
 */
class receivableBase extends WebAPI {
	...
	function __construct() {
		...
		// $logfilepath = __LOCALDB_DIR . "/output//*receivable*/.txt";
		// debug::disable();
