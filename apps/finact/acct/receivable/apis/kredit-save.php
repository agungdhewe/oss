...
/**
 * finact/acct/receivable/apis/kredit-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel kredit receivable (trn_jurnal)
 *
		...
		try {
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'jurnaldetil_id', 'partner_id', 'jurnaldetil_descr', 'jurnaldetil_valfrg', 'curr_id', 'jurnaldetil_valfrgrate', 'jurnaldetil_validr', 'coa_id', 'dept_id', 'jurnal_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
