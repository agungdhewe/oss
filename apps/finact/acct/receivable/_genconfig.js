...
module.exports = {
	...
	persistent: {
		'trn_jurnal': {
			...
			data: {
				...
				jurnal_valfrg: { text: 'Value', type: dbtype.decimal(14, 2), null: false, default: 0, suppresslist: true,  hidden: true, options: { required: true , disabled: true} },
				curr_id: {
		...
		'trn_jurnaldetil' : {
			...
			data: {
				...
				jurnaldetil_valfrg: { text: 'Value', type: dbtype.decimal(14, 2), null: false, default: 0, suppresslist: true, options: { required: true } },
				curr_id: {
					text:'Currency', type: dbtype.varchar(10), null:false, suppresslist: true,
	...
	schema: {
		header: 'trn_jurnal',
		detils: {
			'debet': {title: 'Detil', table: 'trn_jurnaldetil', form: true, headerview: 'jurnal_descr' },
			'kredit': {title: 'Kredit', table: 'trn_jurnaldetil', form: true, headerview: 'jurnal_descr' },
