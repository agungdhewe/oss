		...
		try {
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'jurnaltypecoa_id', 'coa_id', 'jurnaltypecoa_isdebet', 'jurnaltypecoa_iskredit', 'jurnaltype_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
