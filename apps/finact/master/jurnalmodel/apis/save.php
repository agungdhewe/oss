	...
	public function execute($data, $options) {
		...
		try {
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey, 'jurnalmodel_id', 'jurnalmodel_name', 'jurnalmodel_isdisabled', 'jurnalmodel_descr', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
