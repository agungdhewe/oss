...
$API = new class extends coaBase {
	...
	public function execute($options) {
		...
		try {
			...
			$sql = \FGTA4\utils\SqlUtility::Select('mst_coa A', [
				'coa_id', 'coagroup_id', 'coa_name', 'coa_nameshort', 'curr_id', 'coa_dk', 'coa_descr', 'coa_isdisabled', 'coamodel_id', 'coareport_id', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
