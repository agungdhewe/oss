...
/**
 * finact/master/projecttype/apis/modeltransaksi-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel modeltransaksi projecttype (mst_projecttype)
 *
...
$API = new class extends projecttypeBase {
	...
	public function execute($data, $options) {
		$tablename = 'mst_projecttypetrxmodel';
		$primarykey = 'projecttypetrxmodel_id';
		...
		try {
			...
			$obj->projecttypetrxmodel_id = strtoupper($obj->projecttypetrxmodel_id);
			...
			try {
				...
				$header_table = 'mst_projecttype';
				$header_primarykey = 'projecttype_id';
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'projecttypetrxmodel_id', 'trxmodel_id', 'coa_id', 'unbill_coa_id', 'projecttype_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
