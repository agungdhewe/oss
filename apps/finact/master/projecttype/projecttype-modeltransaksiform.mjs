...
const obj = {
	txt_projecttypetrxmodel_id: $('#pnl_editmodeltransaksiform-txt_projecttypetrxmodel_id'),
	...
	txt_projecttype_id: $('#pnl_editmodeltransaksiform-txt_projecttype_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_projecttypetrxmodel_id,
		autoid: true,
		logview: 'mst_projecttypetrxmodel',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.projecttype_name)
	header_data = hdata
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		data.projecttype_id= hdata.projecttype_id
...
function form_idsetup(options) {
	var objid = obj.txt_projecttypetrxmodel_id
