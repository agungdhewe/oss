  ...
  persistent: {
    'mst_accbudgetgroup': {
      ...
      data: {
        ...
        accbudgetgroup_name: { text: 'Group Budget Accout', type: dbtype.varchar(90), uppercase: true, options: { required: true, invalidMessage: 'Nama Group COA harus diisi' } },
        ...
        accbudgetgroup_path: { text: 'Path', type: dbtype.varchar(340), null: false, uppercase: true, suppresslist: true, options: { disabled: true } },
        accbudgetgroup_pathid: { text: 'PathId', type: dbtype.varchar(17), null: false, uppercase: true, suppresslist: true, options: { disabled: true } },
