		...
		try {
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'trxmodel_id', 'trxmodel_name', 'trxmodel_descr', 'trxmodel_direction', 'ppn_taxtype_id', 'pph_taxtype_id', 'trxmodel_isuseqty', 'trxmodel_isusedays', 'trxmodel_isusetask', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
