...
const obj = {
	txt_salesordertype_id: $('#pnl_edit-txt_salesordertype_id'),
	txt_salesordertype_name: $('#pnl_edit-txt_salesordertype_name'),
	txt_salesordertype_descr: $('#pnl_edit-txt_salesordertype_descr'),
	cbo_trxmodel_id: $('#pnl_edit-cbo_trxmodel_id'),
	cbo_sales_coa_id: $('#pnl_edit-cbo_sales_coa_id'),
	cbo_discount_coa_id: $('#pnl_edit-cbo_discount_coa_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_salesordertype_id,
		autoid: false,
		logview: 'mst_salesordertype',
	...
	new fgta4slideselect(obj.cbo_discount_coa_id, {
		title: 'Pilih discount_coa_id',
		returnpage: this_page_id,
		api: $ui.apis.load_discount_coa_id,
		fieldValue: 'discount_coa_id',
		fieldValueMap: 'coa_id',
		fieldDisplay: 'coa_name',
		fields: [
			{mapping: 'coa_id', text: 'coa_id'},
...
export function open(data, rowid, viewmode=true, fn_callback) {
	...
	var fn_dataopened = async (result, options) => {
		...
		form
			...
			.setValue(obj.cbo_sales_coa_id, result.record.sales_coa_id, result.record.sales_coa_name)
			.setValue(obj.cbo_discount_coa_id, result.record.discount_coa_id, result.record.discount_coa_name)
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		data.discount_coa_id = '0'
		data.discount_coa_name = '-- PILIH --'
...
function form_idsetup(options) {
	var objid = obj.txt_salesordertype_id
