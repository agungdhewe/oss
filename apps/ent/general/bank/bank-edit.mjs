...
const obj = {
	txt_bank_id: $('#pnl_edit-txt_bank_id'),
	txt_bank_name: $('#pnl_edit-txt_bank_name'),
	txt_bank_code: $('#pnl_edit-txt_bank_code'),
	txt_bank_phone: $('#pnl_edit-txt_bank_phone'),
	txt_bank_email: $('#pnl_edit-txt_bank_email'),
	chk_bank_isdisabled: $('#pnl_edit-chk_bank_isdisabled'),
	txt_bank_address: $('#pnl_edit-txt_bank_address'),
	txt_bank_city: $('#pnl_edit-txt_bank_city'),
	txt_bank_prov: $('#pnl_edit-txt_bank_prov'),
...
export function open(data, rowid, viewmode=true, fn_callback) {
	...
	var fn_dataopened = async (result, options) => {
		...
		form
			.fill(result.record)
			.setValue(obj.cbo_country_id, result.record.country_id, result.record.country_name)
			.commit()
