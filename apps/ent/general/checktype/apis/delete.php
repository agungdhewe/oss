...
/**
 * ent/general/checktype/apis/delete.php
 *
 * ======
 * Delete
 * ======
 * Menghapus satu baris data/record berdasarkan PrimaryKey
 * pada tabel header checktype (mst_checktype)
 *
 ...
 * tanggal 10/10/2021
 */
$API = new class extends checktypeBase {
	
	public function execute($data, $options) {
		$tablename = 'mst_checktype';
		$primarykey = 'checktype_id';
