...
/**
 * ent/affiliation/partner/apis/ref-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel ref partner (mst_partner)
	...
	public function execute($options) {
		...
		try {
			...
			$stmt = $this->db->prepare("
				select 
				A.partnerref_id, A.interface_id, A.partnerref_code, A.partner_id, A._createby, A._createdate, A._modifyby, A._modifydate 
