...
/**
 * ent/affiliation/partner/apis/type-save.php
 *
 * ==========
 * Detil-Save
 * ==========
...
$API = new class extends partnerBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->partnerastype_id = strtoupper($obj->partnerastype_id);
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'partnerastype_id', 'partnertype_id', 'partner_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
