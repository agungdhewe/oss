...
const obj = {
	...
	chk_partnecontact_iscontract: $('#pnl_editcontactform-chk_partnecontact_iscontract'),
	chk_partnecontact_isinvoice: $('#pnl_editcontactform-chk_partnecontact_isinvoice'),
