...
/**
 * ent/affiliation/brand/apis/partner-open.php
 *
 * ==========
 * Detil-Open
 * ==========
	...
	public function execute($options) {
		...
		try {
			...
			$where = \FGTA4\utils\SqlUtility::BuildCriteria(
				$options->criteria,
				[
					"brandpartner_id" => " brandpartner_id = :brandpartner_id "
				]
			);

			$sql = \FGTA4\utils\SqlUtility::Select('mst_brandpartner A', [
				'brandpartner_id', 'partner_id', 'brand_id', '_createby', '_createdate', '_modifyby', '_modifydate' 
			], $where->sql);
