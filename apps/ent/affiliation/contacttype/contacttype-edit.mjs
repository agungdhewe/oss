...
const obj = {
	txt_contacttype_id: $('#pnl_edit-txt_contacttype_id'),
	txt_contacttype_name: $('#pnl_edit-txt_contacttype_name'),
	txt_contacttype_descr: $('#pnl_edit-txt_contacttype_descr')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_contacttype_id,
		autoid: false,
		logview: 'mst_contacttype',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_contacttype_id
