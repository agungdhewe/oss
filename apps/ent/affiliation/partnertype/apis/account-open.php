	...
	public function execute($options) {
		...
		try {
			...
			$sql = \FGTA4\utils\SqlUtility::Select('mst_partnertypeaccbudget A', [
				'partnertypeaccbudget_id', 'projectmodel_id', 'unbill_accbudget_id', 'unbill_coa_id', 'payable_accbudget_id', 'payable_coa_id', 'arunbill_accbudget_id', 'arunbill_coa_id', 'ar_accbudget_id', 'ar_coa_id', 'partnertype_id', '_createby', '_createdate', '_modifyby', '_modifydate' 
			], $where->sql);
