...
const obj = {
	txt_partnercategory_id: $('#pnl_edit-txt_partnercategory_id'),
	txt_partnercategory_name: $('#pnl_edit-txt_partnercategory_name'),
	txt_partnercategory_descr: $('#pnl_edit-txt_partnercategory_descr')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_partnercategory_id,
		autoid: false,
		logview: 'mst_partnercategory',
...
function form_idsetup(options) {
	var objid = obj.txt_partnercategory_id
