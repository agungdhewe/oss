...
/**
 * ent/organisation/unit/apis/save.php
 *
 * ====
 * Save
 * ====
...
$API = new class extends unitBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			if ($obj->unit_descr=='') { $obj->unit_descr = '--NULL--'; }
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'unit_id', 'unit_name', 'unit_descr', 'unit_isdisabled', 'unitgroup_id', 'dept_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
