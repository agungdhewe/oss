	...
	public function execute($data, $options) {
		...
		try {
			...
			try {
				...
				$header_table = 'mst_auth';
				$header_primarykey = 'auth_id';
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey,  'authdelegate_id', 'authdelegate_portion', 'empl_id', 'auth_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
