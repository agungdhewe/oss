...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		$tablename = 'mst_depttype';
		$primarykey = 'depttype_id';
		...
		try {
			...
			$obj->depttype_name = strtoupper($obj->depttype_name);
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey, 'depttype_id', 'depttype_name', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
