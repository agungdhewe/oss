...
const obj = {
	txt_sitemodel_id: $('#pnl_edit-txt_sitemodel_id'),
	txt_sitemodel_name: $('#pnl_edit-txt_sitemodel_name'),
	txt_sitemodel_descr: $('#pnl_edit-txt_sitemodel_descr')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_sitemodel_id,
		autoid: false,
		logview: 'mst_sitemodel',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_sitemodel_id
