...
const obj = {
	txt_zone_id: $('#pnl_edit-txt_zone_id'),
	txt_zone_name: $('#pnl_edit-txt_zone_name'),
	chk_zone_isdisabled: $('#pnl_edit-chk_zone_isdisabled'),
	txt_zone_descr: $('#pnl_edit-txt_zone_descr'),
