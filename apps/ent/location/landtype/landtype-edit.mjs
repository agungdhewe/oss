...
const obj = {
	txt_landtype_id: $('#pnl_edit-txt_landtype_id'),
	txt_landtype_name: $('#pnl_edit-txt_landtype_name'),
	txt_landtype_descr: $('#pnl_edit-txt_landtype_descr')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_landtype_id,
		autoid: false,
		logview: 'mst_landtype',
		btn_edit: btn_edit,
		btn_save: btn_save,
