...
const obj = {
	txt_area_id: $('#pnl_edit-txt_area_id'),
	txt_area_name: $('#pnl_edit-txt_area_name'),
	txt_area_descr: $('#pnl_edit-txt_area_descr')
}
