...
const obj = {
	txt_sitegroup_id: $('#pnl_edit-txt_sitegroup_id'),
	txt_sitegroup_name: $('#pnl_edit-txt_sitegroup_name'),
	txt_sitegroup_descr: $('#pnl_edit-txt_sitegroup_descr')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_sitegroup_id,
		autoid: false,
		logview: 'mst_sitegroup',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_sitegroup_id
