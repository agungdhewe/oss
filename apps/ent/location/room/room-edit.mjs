...
const obj = {
	txt_room_id: $('#pnl_edit-txt_room_id'),
	txt_room_name: $('#pnl_edit-txt_room_name'),
	chk_room_isdisabled: $('#pnl_edit-chk_room_isdisabled'),
